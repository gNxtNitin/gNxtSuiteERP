...
Public Function GetScheduleDetail(mCompanyCode As Long, mItemCode As String, mDate As String, mFYEAR As Long, pPubDBCn As ADODB.Connection, mScheduleQty As String) As Boolean
On Error GoTo ErrPart
Dim mSqlStr As String
Dim RsTemp As ADODB.Recordset

    mSqlStr = " SELECT SUM(ID.TOTAL_QTY) AS TOTAL_QTY " & vbCrLf _
...
Dim mSubject As String
    ...
    mSubject = " Daily Shortage Report AS ON DATE : " & mDateTime
...
Dim mRate As Double
    ...
    mHeadingline = 1
    mDate = DateAdd("d", -1, Format(PubCurrDate, "DD/MM/YYYY"))     ''Format(PubCurrDate, "DD/MM/YYYY")       ''DateAdd("d", -1, Format(PubCurrDate, "DD/MM/YYYY"))
    mDays = Day(mDate)
    ...
    For I = 1 To 500
        With exlobj.ActiveSheet
            ...
            If GetScheduleDetail(mCompanyCode, mItemCode, mDate, mFYEAR, pPubDBCn, mScheduleQty) = False Then GoTo ErrPart
'            If GetTillDateScheduleDetail(mCompanyCode, mItemCode, mPartyCode, mDate, pPubDbcn, mTillDateScheduleQty) = False Then GoTo ErrPart
            ...
            .Cells(mHeadingline, 7).Value = mRate
            .Cells(mHeadingline, 8).Value = mScheduleQty
            .Cells(mHeadingline, 9).Value = mStock
