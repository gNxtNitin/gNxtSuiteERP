...
Friend Class frmBreakDownToolsMst
...
ErrorPart:
    ...
    Private Sub Clear1()
        ...
        txtName.Text = ""
        txtPbDesc.Text = ""
        cboProbType.Visible = False
        cboProbType.Enabled = False
        '    cboProbType.Text = ""			
...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        PubDBCn.BeginTrans()
        If InsertIntoDelAudit(PubDBCn, "TOL_BDPROBLEMS_MST", (txtName.Text), RsBdProb, "", "D") = False Then GoTo DeleteErr
        If InsertIntoDeleteTrn(PubDBCn, "TOL_BDPROBLEMS_MST", "PROB_CODE", (txtName.Text)) = False Then GoTo DeleteErr

        SqlStr = "DELETE FROM TOL_BDPROBLEMS_MST " & vbCrLf _
...
DelErrPart:
    ...
    Private Sub cmdSearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdsearch.Click
        ...
        If MainClass.SearchGridMaster("", "TOL_BDPROBLEMS_MST", "PROB_DESC", "PROB_CODE", , , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
...
SearchError:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmBreakDownToolsMst_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmBreakDownToolsMst_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub txtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "SELECT * FROM TOL_BDPROBLEMS_MST " & vbCrLf _
            & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
            & " AND PROB_CODE='" & MainClass.AllowSingleQuote(txtName.Text) & "'"
        ...
        Else
            ...
            ElseIf MODIFYMode = True Then
                SqlStr = ""
                SqlStr = "SELECT * FROM TOL_BDPROBLEMS_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND PROB_CODE='" & MainClass.AllowSingleQuote(xCode) & "'"
...
EventExitSub:
    ...
    End Sub
    Private Sub frmBreakDownToolsMst_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated

        On Error GoTo ERR1
        If FormActive = True Then Exit Sub
        MainClass.UOpenRecordSet("Select * From TOL_BDPROBLEMS_MST Where 1<>1 ", PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsBdProb, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmBreakDownToolsMst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmBreakDownToolsMst_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Show1()
        ...
        If Not RsBdProb.EOF Then
            ...
            '        If RsBdProb!PROB_TYPE = "M" Then			
            '            cboProbType.Text = "Mechanical"			
            '        ElseIf RsBdProb!PROB_TYPE = "E" Then			
            '            cboProbType.Text = "Electrical"			
            '        ElseIf RsBdProb!PROB_TYPE = "H" Then			
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            SqlStr = "INSERT INTO TOL_BDPROBLEMS_MST (" & vbCrLf _
        ...
        Else
            SqlStr = " UPDATE TOL_BDPROBLEMS_MST  SET " & vbCrLf _
                & " PROB_DESC='" & MainClass.AllowSingleQuote(txtPbDesc.Text) & "'," & vbCrLf _
                & " PROB_TYPE='" & mProbType & "'," & vbCrLf _
                & " MODUSER='" & MainClass.AllowSingleQuote(PubUserID) & "', " & vbCrLf _
                & " MODDATE=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf _
                & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
                & " AND PROB_CODE= '" & MainClass.AllowSingleQuote(xCode) & "'"
        End If
        PubDBCn.Execute(SqlStr)
        PubDBCn.CommitTrans()
        Update1 = True
...
err_Renamed:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT PROB_CODE,PROB_DESC,DECODE(PROB_TYPE,'M','Mechanical','E','Electrical','H','Hydraulic') AS PROB_TYPE " & vbCrLf & " FROM TOL_BDPROBLEMS_MST" & vbCrLf & " WHERE TOL_BDPROBLEMS_MST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
    ...
    Private Sub ShowReport(ByRef Mode As Crystal.DestinationConstants)
        ...
        SqlStr = " SELECT *  " & vbCrLf & " FROM TOL_BDPROBLEMS_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " ORDER BY PROB_CODE"
