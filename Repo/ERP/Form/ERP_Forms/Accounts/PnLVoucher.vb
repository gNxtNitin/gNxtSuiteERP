...
ERR1:
    ...
    Private Sub cmdAuthorised_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdAuthorised.Click
        ...
        Sqlstr = "UPDATE FIN_PROFITLOSS_HDR SET " & vbCrLf & " UPDATE_FROM='N'," & vbCrLf & " AUTHORISED='Y', " & vbCrLf & " AUTHORISED_CODE='" & MainClass.AllowSingleQuote(PubUserID) & "'," & vbCrLf & " AUTHORISED_DATE=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')," & vbCrLf & " MODDATE=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') "
...
ErrPart:
    ...
    Private Sub CmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDelete.Click
        ...
        If InsertIntoDelAudit(PubDBCn, "FIN_PROFITLOSS_HDR", mVnoStr, RsTRNMain, "", "D") = False Then GoTo DelErrPart

        If InsertIntoDelAudit(PubDBCn, "FIN_PROFITLOSS_DET", mVnoStr, RsTRNDetail, "", "D") = False Then GoTo DelErrPart

        If InsertIntoDeleteTrn(PubDBCn, "FIN_PROFITLOSS_HDR", "MKEY", RsTRNMain.Fields("mKey").Value) = False Then GoTo DelErrPart

        Sqlstr = "Delete From FIN_PROFITLOSS_DET Where Mkey='" & RsTRNMain.Fields("mKey").Value & "'"
        PubDBCn.Execute(Sqlstr)

        Sqlstr = "Delete From FIN_PROFITLOSS_HDR Where Mkey='" & RsTRNMain.Fields("mKey").Value & "'"
        PubDBCn.Execute(Sqlstr)

        Sqlstr = "DELETE FROM FIN_PROFITLOSS_TRN  WHERE Mkey='" & RsTRNMain.Fields("mKey").Value & "'" & vbCrLf & " AND BookType='" & VB.Left(lblBookType.Text, 1) & "'" & vbCrLf & " AND BooksubType='" & VB.Right(lblBookType.Text, 1) & "' "
        PubDBCn.Execute(Sqlstr)
...
ErrPart:
    ...
    Private Function SelectQryForVoucher(ByRef mSqlStr As String, ByRef mVNo As String, ByRef mVDate As Date, ByRef mBookType As String, ByRef mBookCode As String) As String
        ...
        mSqlStr = " SELECT TRN.VNO,TRN.VDATE,TRN.BOOKTYPE,TRN.BOOKSUBTYPE, " & vbCrLf & " TRN.ACCOUNTCODE,TRN.BOOKCODE,TRN.NARRATION, " & vbCrLf & " TRN.AMOUNT,TRN.DC,TRN.CHEQUENO,TRN.CHQDATE, " & vbCrLf & " TRN.IBRNO,TRN.CLEARDATE, " & vbCrLf & " A.SUPP_CUST_Name,B.SUPP_CUST_NAME " & vbCrLf & " FROM FIN_PROFITLOSS_TRN TRN,FIN_SUPP_CUST_MST A" & vbCrLf & " WHERE TRN.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf & " TRN.FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND " & vbCrLf & " TRN.COMPANY_CODE=A.COMPANY_CODE AND " & vbCrLf & " TRN.AccountCode=A.SUPP_CUST_CODE AND" & vbCrLf & " VNO='" & mVNo & "' AND " & vbCrLf & " VDate=TO_DATE('" & VB6.Format(mVDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND " & vbCrLf & " BookType='" & Mid(mBookType, 1, 1) & "' AND " & vbCrLf & " BookSubType='" & Mid(mBookType, 2, 1) & "' "
...
SaveErrPart:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        With SprdMain
            ...
            .set_ColWidth(ColAccountName, 28)
            ...
            .TypeEditCharCase = SS_CELL_EDIT_CASE_UPPER_CASE
            .set_ColWidth(ColParticulars, 23)
...
ErrPart:
    ...
    Private Sub frmPnLVoucher_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmPnLVoucher_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmPnLVoucher_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        Call frmPnLVoucher_Activated(eventSender, eventArgs)
...
ERR1:
    ...
    Public Sub frmPnLVoucher_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
...
ERR1:
    ...
    Private Sub InitialiseTRN()
        ...
        Me.Text = "Depreciation & Stock Voucher"
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        Sqlstr = Sqlstr & vbCrLf & " '' as BankName, FIN_PROFITLOSS_DET.Amount  as Amount " & vbCrLf & " FROM FIN_PROFITLOSS_HDR,FIN_PROFITLOSS_DET, FIN_SUPP_CUST_MST  " & vbCrLf & " WHERE " & vbCrLf & " FIN_PROFITLOSS_HDR.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FIN_PROFITLOSS_HDR.FYEAR=" & RsCompany.Fields("FYEAR").Value & " " & vbCrLf & " AND FIN_PROFITLOSS_HDR.BookType='" & VB.Left(lblBookType.Text, 1) & "' " & vbCrLf & " AND FIN_PROFITLOSS_HDR.BookSubType='" & VB.Right(lblBookType.Text, 1) & "' " & vbCrLf & " AND FIN_PROFITLOSS_HDR.Mkey=FIN_PROFITLOSS_DET.Mkey " & vbCrLf & " AND FIN_SUPP_CUST_MST.COMPANY_CODE=FIN_PROFITLOSS_HDR.COMPANY_CODE " & vbCrLf & " AND FIN_SUPP_CUST_MST.SUPP_CUST_CODE=FIN_PROFITLOSS_DET.AccountCode"

        Sqlstr = Sqlstr & vbCrLf & " ORDER BY TO_DATE(VDATE,'DD/MM/YYYY'), VNO,FIN_PROFITLOSS_DET.SUBROWNO"
...
ERR1:
    ...
    End Sub
    Private Sub frmPnLVoucher_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        'Cancel = 0
        If ADDMode = True Or MODIFYMode = True Then
            If MsgQuestion("Are you sure to Exit") = CStr(MsgBoxResult.No) Then
    ...
    Private Sub SprdMain_LeaveCell(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_LeaveCellEvent) Handles SprdMain.LeaveCell
        ...
        Select Case eventArgs.col
            ...
            Case ColDivisionCode
                ...
                '
                '                    lblAcBalAmtDiv.text = Format(Abs(mOPBalDiv), "0.00")
...
EventExitSub:
    ...
    Public Sub CheckVouchExistance()
        ...
        Sqlstr = " Select * From FIN_PROFITLOSS_HDR WHERE " & vbCrLf & " Vno='" & mVNo & "'" & vbCrLf & " AND Booktype='" & VB.Left(lblBookType.Text, 1) & "'" & vbCrLf & " AND BookSubType='" & VB.Right(lblBookType.Text, 1) & "'" & vbCrLf & " AND COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & ""
...
ERR1:
    ...
    Public Sub CopyVouchExistance()
        ...
        If RsTRNTemp.EOF = False Then
            ...
            Clear1()
            Sqlstr = "SELECT FIN_PROFITLOSS_DET.*" & vbCrLf & " FROM FIN_PROFITLOSS_DET WHERE MKEY= '" & mKey & "' Order By SubRowNo"
...
ShowErrPart:
    ...
    Private Sub ShowDetail()
        ...
        Sqlstr = "SELECT FIN_PROFITLOSS_DET.*" & vbCrLf & " FROM FIN_PROFITLOSS_DET WHERE MKEY= '" & CurMKey & "' Order By SubRowNo" '''& vbCrLf |            & " AND FIN_PROFITLOSS_DET.ACCOUNTCODE=FIN_SUPP_CUST_MST.SUPP_CUST_CODE AND " & vbCrLf |            & " "
        MainClass.UOpenRecordSet(Sqlstr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsTRNDetail, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
    ...
    Private Function CheckLastestVDate(ByRef mVDate As Date, ByRef mVType As String) As Boolean
        ...
        Sqlstr = "SELECT VDATE FROM FIN_PROFITLOSS_HDR " & vbCrLf & " WHERE Company_Code=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf & " FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND " & vbCrLf & " BookType='" & mBookType & "' AND " & vbCrLf & " BookSubType='" & mBookSubType & "' AND " & vbCrLf & " VTYPE='" & MainClass.AllowSingleQuote(Trim(mVType)) & "' AND " & vbCrLf & " VDATE>TO_DATE('" & VB6.Format(mVDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
...
CheckLastestVDateErr:
    ...
    Private Function CheckLastestVNo(ByRef mVNo As Integer, ByRef mVDate As Date, ByRef mVType As String) As Boolean
        ...
        ''Checl Previous VNO...
        Sqlstr = "SELECT Max(VNOSeq) AS VNoSeq FROM FIN_PROFITLOSS_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf & " FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND " & vbCrLf & " BookType='" & mBookType & "' AND " & vbCrLf & " BookSubType='" & mBookSubType & "' AND " & vbCrLf & " VTYPE='" & MainClass.AllowSingleQuote(Trim(mVType)) & "' AND " & vbCrLf & " VDATE<TO_DATE('" & VB6.Format(mVDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
...
CheckLastestVNoErr:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            mRowNo = MainClass.AutoGenRowNo("FIN_PROFITLOSS_HDR", "RowNo", PubDBCn)
            CurMKey = RsCompany.Fields("COMPANY_CODE").Value & VB6.Format(RsCompany.Fields("FYEAR").Value) & VB6.Format(mRowNo)

            Sqlstr = " INSERT INTO FIN_PROFITLOSS_HDR ( " & vbCrLf & " Mkey, COMPANY_CODE, " & vbCrLf & " FYEAR,RowNo, VType, VNoPrefix, VNoSeq, VNoSuffix, " & vbCrLf & " Vno, Vdate, BookType,BookSubType, " & vbCrLf & " BookCode, Narration, CANCELLED, " & vbCrLf & " AUTHORISED, " & vbCrLf & " AddUser, AddDate, ModUser, ModDate,UPDATE_FROM,EXPDATE " & vbCrLf & " ) VALUES ( "

            Sqlstr = Sqlstr & vbCrLf & " '" & CurMKey & "'," & RsCompany.Fields("COMPANY_CODE").Value & "," & vbCrLf & " " & RsCompany.Fields("FYEAR").Value & ", " & vbCrLf & " " & mRowNo & ", " & vbCrLf & " '" & mVType & "', '" & mVNoPrefix & "', " & vbCrLf & " " & Val(mVNo) & ", '" & mVNoSuffix & "', '" & mVnoStr & "', " & vbCrLf & " TO_DATE('" & VB6.Format(TxtVDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf & " '" & mBookType & "', '" & mBookSubType & "', " & vbCrLf & " '" & mBookCode & "', '" & MainClass.AllowSingleQuote(txtNarration.Text) & "', '" & mCancelled & "', " & vbCrLf & " 'N', " & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'),'','','N', " & vbCrLf & " TO_DATE('" & VB6.Format(mExpDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'))"


        ElseIf MODIFYMode = True Then

            Sqlstr = "UPDATE FIN_PROFITLOSS_HDR SET " & vbCrLf & " Vdate=TO_DATE('" & VB6.Format(TxtVDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf & " VType= '" & mVType & "'," & vbCrLf & " VnoPrefix='" & mVNoPrefix & "', " & vbCrLf & " VnoSeq=" & Val(mVNo) & ", " & vbCrLf & " VnoSuffix='" & mVNoSuffix & "', " & vbCrLf & " Vno='" & mVnoStr & "', " & vbCrLf & " BookCode='" & mBookCode & "', " & vbCrLf & " Narration='" & MainClass.AllowSingleQuote(txtNarration.Text) & "', " & vbCrLf & " CANCELLED='" & mCancelled & "', " & vbCrLf & " BookType='" & mBookType & "', " & vbCrLf & " BookSubType='" & mBookSubType & "', " & vbCrLf & " UPDATE_FROM='N'," & vbCrLf & " ModUser='" & MainClass.AllowSingleQuote(PubUserID) & "', " & vbCrLf & " ModDate=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf & " EXPDATE=TO_DATE('" & VB6.Format(mExpDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
...
ErrPart:
    ...
    Private Function GenVno() As String
        ...
        If ADDMode = True Or txtVNo.Text = "" Then
            Sqlstr = "SELECT MAX(VNOSeq) From FIN_PROFITLOSS_HDR WHERE " & vbCrLf & " COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND BookType='" & mBookType & "'" & vbCrLf & " AND BookSubType='" & mBookSubType & "'" & vbCrLf & " AND " & vbCrLf & " VTYPE='" & MainClass.AllowSingleQuote(mVType) & "'"
...
ERR1:
    ...
    Private Function UpdateDetail(ByRef mMKey As String, ByRef mRowNo As Integer, ByRef mBookCode As String, ByRef mVType As String, ByRef mVNo As String, ByRef mVDate As String, ByRef pNarration As String, ByRef pDBCn As ADODB.Connection) As Boolean
        ...
        Sqlstr = "Delete From FIN_PROFITLOSS_DET Where Mkey='" & mMKey & "'"
        pDBCn.Execute(Sqlstr)

        Sqlstr = "DELETE FROM FIN_PROFITLOSS_TRN  WHERE " & vbCrLf & " MKEY ='" & mMKey & "' " & vbCrLf & " AND BookType='" & VB.Left(lblBookType.Text, 1) & "'" & vbCrLf & " AND BooksubType='" & VB.Right(lblBookType.Text, 1) & "'"
        pDBCn.Execute(Sqlstr)
...
EventExitSub:
    ...
    Private Function GetVoucherNetAmount() As Double
        ...
        Sqlstr = "  SELECT SUM(AMOUNT) as AMOUNT FROM FIN_PROFITLOSS_TRN " & vbCrLf & " WHERE MKEY='" & CurMKey & "'" & vbCrLf & " AND BOOKTYPE='" & VB.Left(lblBookType.Text, 1) & "'" & vbCrLf & " AND BOOKSUBTYPE='" & VB.Right(lblBookType.Text, 1) & "' AND SUBROWNO=-1"
        MainClass.UOpenRecordSet(Sqlstr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsTemp, ADODB.LockTypeEnum.adLockReadOnly)
