...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        PubDBCn.BeginTrans()
        If InsertIntoDelAudit(PubDBCn, "PRD_FAULT_MST", (txtName.Text), RsPDIFault, "NAME") = False Then GoTo DeleteErr
        If InsertIntoDeleteTrn(PubDBCn, "PRD_FAULT_MST", "NAME", (txtName.Text)) = False Then GoTo DeleteErr

        SqlStr = "DELETE FROM PRD_FAULT_MST " & vbCrLf _
...
DelErrPart:
    ...
    Private Sub cmdsearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdsearch.Click
        ...
        If MainClass.SearchGridMaster(txtName.Text, "PRD_FAULT_MST", "NAME", "CODE", "", "", "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
            txtName.Text = AcName
...
SearchError:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmPDIProblemMst_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmPDIProblemMst_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub TxtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "SELECT * FROM PRD_FAULT_MST " & vbCrLf _
            & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
        ...
        Else
            If ADDMode = False And MODIFYMode = False Then
                MsgBox("Fault Does Not Exist In Master" & vbCrLf & "Click Add To Add In Master")
                Cancel = True
            ElseIf MODIFYMode = True Then
                Sqlstr = ""
                Sqlstr = "SELECT * FROM PRD_FAULT_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND CODE=" & xCode & ""
...
EventExitSub:
    ...
    End Sub
    Private Sub frmPDIProblemMst_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated

        On Error GoTo ERR1
        If FormActive = True Then Exit Sub
        MainClass.UOpenRecordSet("Select * From PRD_FAULT_MST Where 1<>1 ", PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsPDIFault, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmPDIProblemMst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmPDIProblemMst_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            ...
            Sqlstr = "INSERT INTO PRD_FAULT_MST (" & vbCrLf & " COMPANY_CODE, CODE, NAME) VALUES ( " & vbCrLf & " " & RsCompany.Fields("COMPANY_CODE").Value & ", " & mCode & ", '" & MainClass.AllowSingleQuote(txtName.Text) & "'" & vbCrLf & " )"

        Else
            Sqlstr = " UPDATE PRD_FAULT_MST  SET " & vbCrLf & " NAME='" & MainClass.AllowSingleQuote(txtName.Text) & "'" & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND CODE= " & xCode & ""
        End If
UpdatePart:
        PubDBCn.Execute(Sqlstr)
        PubDBCn.CommitTrans()
...
err_Renamed:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        Sqlstr = " SELECT NAME " & vbCrLf & " FROM PRD_FAULT_MST" & vbCrLf & " WHERE PRD_FAULT_MST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
    ...
    Private Sub ShowReportOld(ByRef Mode As Crystal.DestinationConstants)
        ...
        Report1.ReportFileName = My.Application.Info.DirectoryPath & "\reports\FaultMst.rpt"
