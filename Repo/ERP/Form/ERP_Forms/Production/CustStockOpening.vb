...
Friend Class frmCustStockOpening
...
AddErr:
    ...
    Private Sub CmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDelete.Click
        ...
        If ValidateBookLocking(PubDBCn, CInt(ConLockSTN), txtRefDate.Text) = True Then
            Exit Sub
        End If
        ...
        If Not RsOPMain.EOF Then
            If MsgQuestion("Want to Delete ? ") = CStr(MsgBoxResult.Yes) Then ' User chose Yes.
                ...
                PubDBCn.BeginTrans()
                If InsertIntoDelAudit(PubDBCn, "PPC_CUST_OP_HDR", (txtRefNo.Text), RsOPMain, "AUTO_KEY_REF") = False Then GoTo DelErrPart
                If InsertIntoDeleteTrn(PubDBCn, "PPC_CUST_OP_HDR", "AUTO_KEY_REF", (txtRefNo.Text)) = False Then GoTo DelErrPart

                PubDBCn.Execute("Delete from PPC_CUST_OP_DET Where AUTO_KEY_REF=" & Val(txtRefNo.Text) & "")
                PubDBCn.Execute("Delete from PPC_CUST_OP_HDR Where AUTO_KEY_REF=" & Val(txtRefNo.Text) & "")
...
ErrPart:
    ...
    Private Function SelectQryForSRN(ByRef mSqlStr As String) As String
        ...
        ''''FROM CLAUSE...
        mSqlStr = mSqlStr & vbCrLf & " FROM PPC_CUST_OP_HDR IH, PPC_CUST_OP_DET ID, " & vbCrLf & " INV_ITEM_MST INVMST, FIN_SUPP_CUST_MST DEPTMST "

        ''''WHERE CLAUSE...
        mSqlStr = mSqlStr & vbCrLf & " WHERE " & vbCrLf & " IH.AUTO_KEY_REF=ID.AUTO_KEY_REF" & vbCrLf & " AND IH.COMPANY_CODE=DEPTMST.COMPANY_CODE" & vbCrLf & " AND IH.SUPP_CUST_CODE=DEPTMST.SUPP_CUST_CODE" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND ID.ITEM_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND INVMST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND DEPTMST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.AUTO_KEY_REF=" & Val(txtRefNo.Text) & ""
...
ErrPart:
    ...
    Private Sub frmCustStockOpening_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.Hide()
        Me.Close()
    End Sub
...
ERR1:
    ...
    Private Function AutoGenSeqNo() As String
        ...
        SqlStr = ""
        SqlStr = "SELECT Max(AUTO_KEY_REF)  " & vbCrLf & " FROM PPC_CUST_OP_HDR " & vbCrLf & " WHERE Company_Code=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND SUBSTR(AUTO_KEY_REF,LENGTH(AUTO_KEY_REF)-5,4)=" & RsCompany.Fields("FYEAR").Value & ""
...
AutoGenSeqNoErr:
    ...
    Private Function UpdateMain1() As Boolean
        ...
        If ADDMode = True Then
            lblMKey.Text = mVNoSeq
            SqlStr = "INSERT INTO PPC_CUST_OP_HDR (" & vbCrLf _
            & " AUTO_KEY_REF, COMPANY_CODE, " & vbCrLf _
            & " REF_DATE, SUPP_CUST_CODE, " & vbCrLf _
            & " REMARKS,   " & vbCrLf _
        ...
        ElseIf MODIFYMode = True Then
            SqlStr = ""
            SqlStr = "UPDATE PPC_CUST_OP_HDR SET " & vbCrLf _
            & " SUPP_CUST_CODE='" & txtSuppCustCode.Text & "',  REF_DATE=TO_DATE('" & VB6.Format(txtRefDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')," & vbCrLf _
        ...
        If UpdateDetail1(CStr(Val(CStr(mVNoSeq)))) = False Then GoTo ErrPart
...
ErrPart:
        ...
        ''Resume
    End Function
    Private Function UpdateDetail1(ByRef pVnoseq As String) As Boolean
        ...
        SqlStr = " Delete From PPC_CUST_OP_DET " & vbCrLf & " WHERE AUTO_KEY_REF=" & Val(lblMKey.Text) & ""
        PubDBCn.Execute(SqlStr)
        ...
        With SprdMain
            For I = 1 To .MaxRows - 1
                ...
                If mItemCode <> "" And mQty > 0 Then
                    SqlStr = " INSERT INTO PPC_CUST_OP_DET ( " & vbCrLf & " AUTO_KEY_REF,SERIAL_NO,ITEM_CODE,ITEM_UOM,QTY,REF_DATE," & vbCrLf & " REMARKS,COMPANY_CODE) "
                    SqlStr = SqlStr & vbCrLf & " VALUES (" & Val(lblMKey.Text) & ", " & I & "," & vbCrLf & " '" & MainClass.AllowSingleQuote(mItemCode) & "', " & vbCrLf & " '" & MainClass.AllowSingleQuote(mUOM) & "', " & vbCrLf & " " & mQty & ", TO_DATE('" & VB6.Format(txtRefDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')," & vbCrLf & " '" & MainClass.AllowSingleQuote(mRemarks) & "'," & RsCompany.Fields("COMPANY_CODE").Value & ") "
...
err_Renamed:
    ...
    Private Sub CmdView_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdView.Click
        ViewGrid()
    End Sub
    Public Sub frmCustStockOpening_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
...
ERR1:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = "SELECT  AUTO_KEY_REF AS SRN_NO, REF_DATE, SUPP_CUST_CODE, REMARKS "

        ''FROM CLAUSE...

        SqlStr = SqlStr & vbCrLf & " FROM PPC_CUST_OP_HDR "

        ''WHERE CLAUSE...

        SqlStr = SqlStr & vbCrLf & " WHERE " & vbCrLf & " COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & vbCrLf & " and SUBSTR(AUTO_KEY_REF,LENGTH(AUTO_KEY_REF)-5,4)=" & RsCompany.Fields("FYEAR").Value & ""
...
AssignGridErr:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        With SprdMain
            ...
            .TypeEditLen = MainClass.SetMaxLength("REMARKS", "PPC_CUST_OP_DET", PubDBCn)
    ...
    Private Sub Show1()
        ...
        With RsOPMain
            If Not .EOF Then
                ...
                txtRefNo.Text = IIf(IsDBNull(.Fields("AUTO_KEY_REF").Value), 0, .Fields("AUTO_KEY_REF").Value)
                ...
                Call ShowDetail1(.Fields("AUTO_KEY_REF").Value)
...
ERR1:
        ...
        ''Resume
    End Sub
    Private Sub ShowDetail1(ByRef pReqNum As Double)
        ...
        Dim mQty As Double
        SqlStr = ""
        SqlStr = " SELECT * " & vbCrLf & " FROM PPC_CUST_OP_DET  " & vbCrLf & " Where AUTO_KEY_REF = " & Val(CStr(pReqNum)) & "" & vbCrLf & " Order By SERIAL_NO"
...
ERR1:
    ...
    Private Sub Clear1()
        ...
        MainClass.ButtonStatus(Me, XRIGHT, RsOPMain, ADDMode, MODIFYMode, cmdAdd, cmdModify, cmdClose, cmdSave, cmdDelete, cmdSavePrint, cmdSavePrint, cmdPrint, CmdPreview, cmdSavePrint, CmdView, True)
    End Sub
    Private Sub frmCustStockOpening_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        End If
    End Sub
    Private Sub frmCustStockOpening_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        '    MainClass.DoFunctionKey Me, KeyCode
    End Sub
    Public Sub frmCustStockOpening_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
EventExitSub:
    ...
    Private Sub txtRefNo_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtRefNo.Validating
        ...
        If MODIFYMode = True And RsOPMain.EOF = False Then mReqnum = RsOPMain.Fields("AUTO_KEY_REF").Value

        SqlStr = "Select * From PPC_CUST_OP_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SUBSTR(AUTO_KEY_REF,LENGTH(AUTO_KEY_REF)-5,4)=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND AUTO_KEY_REF=" & Val(txtRefNo.Text) & ""
        ...
        Else
            If ADDMode = False And MODIFYMode = False Then
                ...
                Cancel = True
            ElseIf MODIFYMode = True Then
                SqlStr = "Select * From PPC_CUST_OP_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SUBSTR(AUTO_KEY_REF,LENGTH(AUTO_KEY_REF)-5,4)=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND AUTO_KEY_REF=" & Val(mReqnum) & ""
                MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsOPMain, ADODB.LockTypeEnum.adLockReadOnly)
            End If
        End If
        GoTo EventExitSub
