...
Friend Class FrmPMemoDiaCuttingPlan
    ...
    Private Const ColTotalWeight As Short = 9
    Private Const ColCutLenWt As Short = 10
    ...
    Private Sub cboProductionFrom_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboProductionFrom.TextChanged

        MainClass.SaveStatus(Me.cmdSave, ADDMode, MODIFYMode)
    End Sub
    Private Sub cboProductionFrom_SelectedIndexChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboProductionFrom.SelectedIndexChanged
        Dim mStockQty As Double = 0
        ...
        If Mid(cboProductionFrom.Text, 1, 1) = "F" Then
            mStockQty = GetBalanceStockQty(Trim(txtRMCode.Text), txtPMemoDate.Text, lblRMUOM.Text, txtDept.Text, "ST", "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
        Else
            mStockQty = GetBalanceStockQty(Trim(txtRMCode.Text), txtPMemoDate.Text, lblRMUOM.Text, txtDept.Text, "CL", "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
        End If

        txtStockQty.Text = Format(mStockQty, "0.000")
    End Sub
    Private Sub cmdAdd_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdAdd.Click
        ...
        Else
            ...
            MainClass.ClearGrid(SprdMainScrap)
...
AddErr:
    ...
    Private Sub FillCbo()
        ...
        cboProductionFrom.Items.Clear()
        cboProductionFrom.Items.Add(("Fresh Material"))
        cboProductionFrom.Items.Add(("End Pc Material"))

        cboProductionFrom.SelectedIndex = 0
    ...
    Private Sub CmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDelete.Click
        ...
        If Not RsPMemoMain.EOF Then
            If MsgQuestion("Want to Delete ? ") = CStr(MsgBoxResult.Yes) Then
                ...
                PubDBCn.Execute("DELETE FROM PRD_CUTTINGPLAN_EXP WHERE AUTO_KEY_REF=" & Val(lblMKey.Text) & "")
...
ErrPart:
    ...
    Private Sub txtRMCode_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtRMCode.Validating
        ...
        mAvailable = GetBalanceStockQty(Trim(txtRMCode.Text), (txtPMemoDate.Text), mItemUOM, (txtDept.Text), IIf(Mid(cboProductionFrom.Text, 1, 1) = "F", "ST", "CL"), "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
...
EventExitSub:
    ...
    Private Sub cmdSearchRMCode_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSearchRMCode.Click
        ...
        SqlStr = " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.RM_CODE " & vbCrLf & " FROM PRD_NEWBOM_DET IH, INV_ITEM_MST INVMST" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.RM_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'"

        SqlStr = SqlStr & vbCrLf & " UNION ALL"

        SqlStr = SqlStr & vbCrLf & " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.ALTER_RM_CODE " & vbCrLf & " FROM PRD_BOM_ALTER_DET IH, INV_ITEM_MST INVMST" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.ALTER_RM_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'"
...
ErrPart:
    ...
    Private Sub FrmPMemoDiaCuttingPlan_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.Hide()
        Me.Close()
        Me.Dispose()
    End Sub
    ...
    Private Sub SprdMain_ClickEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_ClickEvent) Handles SprdMain.ClickEvent
        ...
        If eventArgs.row = 0 And eventArgs.col = ColItemCode Then
            With SprdMain
                ...
                .Col = ColItemCode
                SqlStr = " SELECT DISTINCT IH.PRODUCT_CODE, INVMST.ITEM_SHORT_DESC" & vbCrLf & " FROM PRD_NEWBOM_DET IH, INV_ITEM_MST INVMST" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.PRODUCT_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'" & vbCrLf & " AND IH.RM_CODE='" & Trim(txtRMCode.Text) & "'"
        ...
        If eventArgs.row = 0 And eventArgs.col = ColItemDesc Then
            With SprdMain
                ...
                .Col = ColItemDesc
                SqlStr = " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.PRODUCT_CODE" & vbCrLf & " FROM PRD_NEWBOM_DET IH, INV_ITEM_MST INVMST" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.PRODUCT_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'" & vbCrLf & " AND IH.RM_CODE='" & Trim(txtRMCode.Text) & "'"
    ...
    Private Sub SprdMain_LeaveCell(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_LeaveCellEvent) Handles SprdMain.LeaveCell
        ...
        Select Case eventArgs.col
            Case ColItemCode
                ...
                If ValidateBOM(mItemCode) = False Then
                    MsgInformation("Please Check Item, Not defined in BOM.")
        ...
        With SprdMain
            ...
            .Col = ColWt_Per_No
            .Text = VB6.Format(mWeightPerStrip, "0.000")
...
ErrPart:
    ...
    Private Sub CalcTots()
        ...
        Dim mNetCTLWt As Double
        Dim mTotNetCTLWt As Double

        Dim mNetScrapWt As Double
        Dim mTotScrapWt As Double
        ...
        With SprdMain
            For i = 1 To .MaxRows
                ...
                If Trim(.Text) <> "" Then
                    ...
                    .Col = ColCutLenWt
                    mNetCTLWt = Val(.Text)
                    mTotNetCTLWt = mTotNetCTLWt + mNetCTLWt
        ...
        With SprdMainScrap
            For i = 1 To .MaxRows
                ...
                If Trim(.Text) <> "" Then
                    ...
                    .Col = ColScrapQty
                    mNetScrapWt = Val(.Text)
                    mTotScrapWt = mTotScrapWt + mNetScrapWt

                End If
            Next i
        End With

        txtNetRMWt.Text = VB6.Format(mTotNetWt, "#0.00")
        txtCTLWt.Text = VB6.Format(Val(mTotNetCTLWt), "#0.00")
        txtNetScrapWt.Text = VB6.Format(Val(mTotScrapWt), "0.00")

        txtGrossRMWt.Text = VB6.Format(mTotNetWt + mTotNetCTLWt + mTotScrapWt, "#0.00")
...
ERR1:
    ...
    Private Function DuplicateItem() As Boolean
        ...
        End With
    End Function
    Private Function ValidateBOM(ByRef mItemCode As String) As Boolean
        Dim cntRow As Integer
        Dim SqlStr As String
        Dim RsTemp As ADODB.Recordset = Nothing

        ValidateBOM = False
        SqlStr = " SELECT IH.PRODUCT_CODE" & vbCrLf _
            ...
            & " AND ID.RM_CODE='" & Trim(txtRMCode.Text) & "' AND IH.PRODUCT_CODE='" & Trim(mItemCode) & "' AND IH.STATUS='O'"
        ...
        If RsTemp.EOF = True Then
            SqlStr = " SELECT IH.PRODUCT_CODE" & vbCrLf _
                ...
                & " WHERE IH.MKEY=ID.MKEY AND IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
                & " AND ID.DEPT_CODE='" & Trim(txtDept.Text) & "'" & vbCrLf _
                & " AND ID.ALTER_RM_CODE='" & Trim(txtRMCode.Text) & "' AND IH.PRODUCT_CODE='" & Trim(mItemCode) & "' AND IH.STATUS='O'"
    ...
    End Function
    Private Function DuplicateScrapItem() As Boolean
        Dim cntRow As Integer
        Dim mCount As Byte
        Dim mCheckItemCode As String
        Dim mItemCode As String
        ...
        With SprdMainScrap
            ...
            For cntRow = 1 To .MaxRows
                ...
                If mCount > 1 Then
                    DuplicateScrapItem = True
                    MsgInformation("Duplicate Scrap Item : " & mCheckItemCode)
                    Exit Function
                End If
            Next
        End With
...
ERR1:
        ...
        MsgInformation(Err.Description)
    End Function
    Private Function FillScrapItemDescPart(ByRef pItemCode As String, ByRef mDivisionCode As Double) As Boolean
        ...
        FillScrapItemDescPart = False
        If Trim(pItemCode) = "" Then Exit Function

        SqlStr = "SELECT IMST.ITEM_CODE, IMST.ITEM_SHORT_DESC,IMST.ISSUE_UOM,IMST.CATEGORY_CODE " & vbCrLf _
                & " FROM INV_ITEM_MST IMST, INV_GENERAL_MST GMAT" & vbCrLf _
                & " WHERE IMST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf _
                & " AND IMST.COMPANY_CODE=GMAT.COMPANY_CODE " & vbCrLf _
                & " AND IMST.CATEGORY_CODE=GMAT.GEN_CODE AND  GMAT.GEN_TYPE='C' AND PRD_TYPE='4'" & vbCrLf _
                & " AND LTRIM(RTRIM(IMST.ITEM_CODE))='" & MainClass.AllowSingleQuote(pItemCode) & "'"
    ...
    Private Function UpdateMain1() As Boolean
        ...
        If ADDMode = True Then
            ...
            SqlStr = " INSERT INTO PRD_CUTTINGPLAN_HDR  " & vbCrLf _
                ...
                & " RM_LENGTH, RM_NET_WT, CTL_NET_WT, SCRAP_NET_WT, PRODUCTION_FROM, HEAT_NO,MACHINE_NO" & vbCrLf _
                & " ) VALUES ( " & vbCrLf _
                ...
                & " 0, " & Val(txtThickness.Text) & ", 0," & vbCrLf _
                & " 0, " & Val(txtNetRMWt.Text) & ", " & Val(txtCTLWt.Text) & ", " & Val(txtNetScrapWt.Text) & ", '" & VB.Left(cboProductionFrom.Text, 1) & "'," & vbCrLf _
                & " '" & MainClass.AllowSingleQuote(txtHeatNo.Text) & "','" & MainClass.AllowSingleQuote(txtMachineNo.Text) & "')"

        ElseIf MODIFYMode = True Then
            mEntryDate = VB6.Format(PubCurrDate, "DD-MMM-YYYY") & " " & GetServerTime()
            SqlStr = " UPDATE PRD_CUTTINGPLAN_HDR  SET " & vbCrLf _
                & " AUTO_KEY_REF=" & mPMemoNo & ", HEAT_NO='" & MainClass.AllowSingleQuote(txtHeatNo.Text) & "'," & vbCrLf _
                ...
                & " MACHINE_NO='" & MainClass.AllowSingleQuote(txtMachineNo.Text) & "', DEPT_CODE='" & MainClass.AllowSingleQuote(txtDept.Text) & "', " & vbCrLf _
                & " SHIFT_CODE='" & cboShiftcd.Text & "', PRODUCTION_FROM= '" & VB.Left(cboProductionFrom.Text, 1) & "'," & vbCrLf _
                ...
                & " RM_QTY=0, RM_THICKNESS=" & Val(txtThickness.Text) & ", RM_WIDTH= 0, " & vbCrLf _
                & " RM_LENGTH=0, RM_NET_WT=" & Val(txtNetRMWt.Text) & ",  CTL_NET_WT=" & Val(txtCTLWt.Text) & ", SCRAP_NET_WT=" & Val(txtNetScrapWt.Text) & "" & vbCrLf _
                & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf _
...
ErrPart:
    ...
    Private Function UpdateDetail1(ByRef pErrorDesc As String, ByRef mDivisionCode As Double) As Boolean
        ...
        SqlStr = " DELETE FROM PRD_CUTTINGPLAN_EXP " & vbCrLf & " WHERE AUTO_KEY_REF=" & Val(lblMKey.Text) & " "
        PubDBCn.Execute(SqlStr)
            ...
            For i = 1 To .MaxRows - 1
                ...
                If mItemCode <> "" And mProdQty > 0 Then
                    SqlStr = " INSERT INTO PRD_CUTTINGPLAN_DET ( " & vbCrLf _
                            ...
                            & " SF_QTY, SF_NET_WT, CUT_LEN_WT, REMARKS) " & vbCrLf _
                            & " VALUES (" & RsCompany.Fields("COMPANY_CODE").Value & "," & Val(lblMKey.Text) & ", " & i & "," & vbCrLf _
                            & " '" & mItemCode & "','" & mUOM & "', " & mSFThickNess & ", " & vbCrLf & " " & mSFWidth & ", " & mSFLength & ", " & mSFWtPerUnit & "," & vbCrLf _
                            & " " & mProdQty & ", " & mSFNetWt & ", " & mCutLenWt & ", '" & MainClass.AllowSingleQuote(mRemarks) & "'" & vbCrLf _
                            & " )"

                    PubDBCn.Execute(SqlStr)

                    If UpdateStockTRN(PubDBCn, ConStockRefType_PMEMODEPT, (txtPMemoNo.Text), xStockRowNo, mProdDate, mProdDate, "ST", mItemCode,
                                      mUOM, CStr(-1), mProdQty, 0, "I", xItemCost, xItemCost, "-1", "", (txtDept.Text), (txtDept.Text), mInCCCode, "N",
                                      "From : " & lblDept.Text & "  : (Production Cutting Plan) -" & ConStockRefType_PMEMODEPT, "-1", ConPH, mDivisionCode, "",
                                      (txtRMCode.Text)) = False Then GoTo UpdateDetail1Err
...
NextRec:
        ...
        If UpdateStockTRN(PubDBCn, ConStockRefType_PMEMODEPT, (txtPMemoNo.Text), xStockRowNo, (mProdDate), (mProdDate), IIf(Mid(cboProductionFrom.Text, 1, 1) = "F", "ST", "CL"),
                          (txtRMCode.Text), (lblRMUOM.Text), CStr(-1), Val(txtGrossRMWt.Text), 0, "O", xItemCost, xItemCost, "-1", "", (txtDept.Text),
                          (txtDept.Text), mInCCCode, "N", "From : " & lblDept.Text & "  : (Production Cutting Plan) -" & ConStockRefType_PMEMODEPT, "-1", ConPH,
                           mDivisionCode, "", "",, Trim(txtHeatNo.Text)) = False Then GoTo UpdateDetail1Err


        xStockRowNo = xStockRowNo + 1

        If UpdateStockTRN(PubDBCn, ConStockRefType_PMEMODEPT, (txtPMemoNo.Text), xStockRowNo, (mProdDate), (mProdDate), "CL", Trim(txtRMCode.Text),
                                      lblRMUOM.Text, CStr(-1), Val(txtCTLWt.Text), 0, "I", xItemCost, xItemCost, "-1", "", (txtDept.Text), (txtDept.Text), mInCCCode, "N",
                                      "From : " & lblDept.Text & "  : (Production Cutting Plan) -" & ConStockRefType_PMEMODEPT, "-1", ConPH, mDivisionCode, "",
                                      (txtRMCode.Text),, Trim(txtHeatNo.Text)) = False Then GoTo UpdateDetail1Err
        ...
        With SprdMainScrap
            For i = 1 To .MaxRows - 1
                ...
                If mItemCode <> "" And mScrapQty > 0 Then
                    SqlStr = " INSERT INTO PRD_CUTTINGPLAN_EXP ( " & vbCrLf _
                            & " COMPANY_CODE, AUTO_KEY_REF, SERIAL_NO, " & vbCrLf _
                            & " SCRAP_CODE, SCRAP_UOM, SCRAP_QTY) " & vbCrLf _
                            & " VALUES (" & RsCompany.Fields("COMPANY_CODE").Value & "," & Val(lblMKey.Text) & ", " & i & "," & vbCrLf _
                            & " '" & mItemCode & "','" & mUOM & "', " & mScrapQty & "" & vbCrLf _
                            & " )"

                    PubDBCn.Execute(SqlStr)

                    If UpdateStockTRN(PubDBCn, ConStockRefType_PMEMODEPT, (txtPMemoNo.Text), xStockRowNo, (mProdDate), (mProdDate), "SC", mItemCode,
                                      mUOM, CStr(-1), mScrapQty, 0, "I", xItemCost, xItemCost, "-1", "", (txtDept.Text), (txtDept.Text), mInCCCode, "N",
                                      "From : " & lblDept.Text & "  : (Production Cutting Plan) -" & ConStockRefType_PMEMODEPT, "-1", ConPH, mDivisionCode, "",
                                      (txtRMCode.Text),, Trim(txtHeatNo.Text)) = False Then GoTo UpdateDetail1Err
        ...
        'If UpdateStockTRN(PubDBCn, ConStockRefType_PMEMODEPT, (txtPMemoNo.Text), xStockRowNo, (txtPMemoDate.Text), (txtPMemoDate.Text), "SC",
        '                  (txtRMCode.Text), (lblRMUOM.Text), CStr(-1), Val(txtNetScrapWt.Text), 0, "I", xItemCost, xItemCost, "-1", "", (txtDept.Text),
        '                  (txtDept.Text), mInCCCode, "N", "From : " & lblDept.Text & "  : (Production Cutting Plan) -" & ConStockRefType_PMEMODEPT, "-1",
        '                  ConPH, mDivisionCode, "", "") = False Then GoTo UpdateDetail1Err
...
UpdateDetail1Err:
    ...
    Private Function CheckRMStock(ByRef pErrorDesc As String, ByRef mMKEY As String, ByRef mFICode As String, ByRef mRMCode As String, ByRef mRMUOM As String, ByRef mDeptCode As String, ByRef pFQty As Double, ByRef pStdQty As Double, ByRef mReqQty As Double, ByRef pStockType As String, ByRef xWareHouse As String, ByRef mDivisionCode As Double) As Boolean
        ...
        mStockQty = GetBalanceStockQty(mRMCode, (txtPMemoDate.Text), mRMUOM, mDeptCode, pStockType, "", xWareHouse, mDivisionCode,,,,, Trim(txtHeatNo.Text))
...
BOMStockErr:
    ...
    Private Function FieldsVarification() As Boolean
        ...
        If cboProductionFrom.Text = "" Then
            MsgBox("Production From is Blank", MsgBoxStyle.Information)
            FieldsVarification = False
            If cboProductionFrom.Enabled = True Then cboProductionFrom.Focus()
            Exit Function
        End If
        ...
        If Trim(txtMachineNo.Text) <> "" Then
            If MainClass.ValidateWithMasterTable(txtMachineNo.Text, "MACHINE_NO", "MACHINE_DESC", "MAN_MACHINE_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND MACHINE_UB='N' AND STATUS='O' AND DIV_CODE=" & mDivisionCode & " AND DEPT_CODE='" & txtDept.Text & "'") = False Then
        ...
        With SprdMain
            For cntRow = 1 To .MaxRows
                ...
                If mProductCode <> "" Then
                    SqlStr = " SELECT PRODUCT_CODE " & vbCrLf & " FROM PRD_NEWBOM_HDR" & vbCrLf _
                        & " WHERE " & vbCrLf _
        ...
        If RsCompany.Fields("STOCKBALCHECK").Value = "Y" Then
            If Val(txtGrossRMWt.Text) > mStockQty Then
                MsgInformation("RM Qty Cann't be Greater Than Stock Qty, Item Code : " & txtRMCode.Text & ". Cann't Be Saved")
                FieldsVarification = False
                'MainClass.SetFocusToCell(SprdMain, cntRow, ColProdQty)
                Exit Function
            End If
...
ERR1:
    ...
    Private Sub CmdView_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdView.Click
        ViewGrid()
    End Sub
    Public Sub FrmPMemoDiaCuttingPlan_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ...
        SqlStr = ""
        SqlStr = "Select * from PRD_CUTTINGPLAN_EXP Where 1<>1"
        MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsPMemoExp, ADODB.LockTypeEnum.adLockReadOnly)
...
AssignGridErr:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        MainClass.ProtectCell(SprdMain, 1, SprdMain.MaxRows, ColLength, ColLength)
        ...
        With SprdMainScrap
            ...
            .TypeEditCharCase = SS_CELL_EDIT_CASE_UPPER_CASE
            .TypeEditMultiLine = False
            .TypeEditLen = RsPMemoExp.Fields("SCRAP_CODE").DefinedSize
            .set_ColWidth(.Col, 9)
            ...
            .TypeEditCharCase = SS_CELL_EDIT_CASE_UPPER_CASE
            .TypeEditMultiLine = True
            .TypeEditLen = RsPMemoExp.Fields("SCRAP_UOM").DefinedSize
            .set_ColWidth(.Col, 4)
        ...
        End With
        MainClass.ProtectCell(SprdMainScrap, 1, SprdMainScrap.MaxRows, ColItemDesc, ColUom)
        MainClass.SetSpreadColor(SprdMainScrap, Arow)
...
ERR1:
    ...
    Private Function GetWeightPerStrip(ByRef mRMThick As Double, ByRef mRMLenth As Double, ByRef mRMWidth As Double, ByRef mDensity As Double) As Double
        ...
        If mRMThick <> 0 And mRMLenth <> 0 And mDensity > 0 Then ''Sheet	
            mWtPerStrip = CDbl(VB6.Format((3.14 / 4) * (mRMThick * mRMThick) * mRMLenth * mDensity / (1000), "0.000")) ''IN Grams	
        End If
...
ErrPart:
    ...
    Private Function GetRodLength(ByRef mRMThick As Double, ByRef mNetWt As Double, ByRef mDensity As Double) As Double
        On Error GoTo ErrPart
        ...
        'If mRMThick > 0 And mNetWt > 0 And Val(txtRMQty.Text) > 0 And mDensity > 0 Then ''Sheet	
        '    'mWtPerStrip = CDbl(VB6.Format((3.14 / 4) * (mRMThick * mRMThick) * mRMLenth * mDensity / (1000), "0.000")) ''IN Grams	

        '    GetRodLength = (mNetWt * 1000 * 1000) / ((3.14 / 4) * (mRMThick * mRMThick) * Val(txtRMQty.Text) * mDensity)
        'End If

        'GetRodLength = VB6.Format(GetRodLength, "0.000")
    ...
    Private Sub Show1()
        ...
        With RsPMemoMain
            If Not .EOF Then
                ...
                mProdFrom = IIf(IsDBNull(.Fields("PRODUCTION_FROM").Value), "F", .Fields("PRODUCTION_FROM").Value)
                If mProdFrom = "F" Then
                    cboProductionFrom.SelectedIndex = 0
                Else
                    cboProductionFrom.SelectedIndex = 1
                End If
                ...
                txtHeatNo.Text = IIf(IsDBNull(.Fields("HEAT_NO").Value), "", .Fields("HEAT_NO").Value)
                ...
                If Mid(cboProductionFrom.Text, 1, 1) = "F" Then
                    mAvailable = GetBalanceStockQty(Trim(txtRMCode.Text), (txtPMemoDate.Text), (lblRMUOM.Text), (txtDept.Text), "ST", "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
                Else
                    mAvailable = GetBalanceStockQty(Trim(txtRMCode.Text), (txtPMemoDate.Text), (lblRMUOM.Text), (txtDept.Text), "CL", "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
                End If

                txtStockQty.Text = VB6.Format(mAvailable, "0.00")

                txtMachineNo.Text = IIf(IsDBNull(.Fields("MACHINE_NO").Value), "", .Fields("MACHINE_NO").Value)
                txtMachineNo_Validating(txtMachineNo, New System.ComponentModel.CancelEventArgs(False))

                Call ShowDetail1(mDivisionCode)
                Call CalcTots()
                Call MakeEnableDesableField(False)
                txtSearchBOM.Enabled = False
                cmdSearchBOM.Enabled = False
                cmdPopulateBOM.Enabled = False
            End If
        End With
        ADDMode = False
        MODIFYMode = False
...
ERR1:
    ...
    Private Sub ShowDetail1(ByRef mDivisionCode As Double)
        ...
        SqlStr = " SELECT * " & vbCrLf & " FROM PRD_CUTTINGPLAN_DET  " & vbCrLf & " WHERE AUTO_KEY_REF = " & Val(lblMKey.Text) & " " & vbCrLf & " ORDER BY  SERIAL_NO"
        MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsPMemoDetail, ADODB.LockTypeEnum.adLockReadOnly)
        With RsPMemoDetail
            ...
            Do While Not .EOF
                ...
                SprdMain.Col = ColCutLenWt
                SprdMain.Text = CStr(Val(IIf(IsDBNull(.Fields("CUT_LEN_WT").Value), "", .Fields("CUT_LEN_WT").Value)))
        ...
        SqlStr = " SELECT * " & vbCrLf & " FROM PRD_CUTTINGPLAN_EXP  " & vbCrLf & " WHERE AUTO_KEY_REF = " & Val(lblMKey.Text) & " " & vbCrLf & " ORDER BY  SERIAL_NO"
        MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsPMemoExp, ADODB.LockTypeEnum.adLockReadOnly)
        ...
        With RsPMemoExp
            ...
            Do While Not .EOF
                ...
                SprdMainScrap.Col = ColItemCode
                SprdMainScrap.Text = Trim(IIf(IsDBNull(.Fields("SCRAP_CODE").Value), "", .Fields("SCRAP_CODE").Value))
                mProdItemCode = Trim(SprdMainScrap.Text)

                SprdMainScrap.Col = ColItemDesc
                If MainClass.ValidateWithMasterTable(Trim(mProdItemCode), "ITEM_CODE", "ITEM_SHORT_DESC", "INV_ITEM_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
                    SprdMainScrap.Text = Trim(MasterNo)
                End If

                SprdMainScrap.Col = ColUom
                SprdMainScrap.Text = IIf(IsDBNull(.Fields("SCRAP_UOM").Value), "", .Fields("SCRAP_UOM").Value)
                mItemUOM = Trim(SprdMainScrap.Text)


                SprdMainScrap.Col = ColScrapQty
                SprdMainScrap.Text = CStr(Val(IIf(IsDBNull(.Fields("SCRAP_QTY").Value), "", .Fields("SCRAP_QTY").Value)))

                .MoveNext()

                i = i + 1
                SprdMainScrap.MaxRows = i
            Loop
        End With
        FormatSprdMain(-1)
        Exit Sub
ERR1:
    ...
    Private Sub Clear1()
        ...
        txtNetScrapWt.Text = "0.00"
        txtSearchBOM.Text = ""

        txtSearchBOM.Enabled = True
        cmdSearchBOM.Enabled = True
        cmdPopulateBOM.Enabled = True
    ...
    End Sub
    Private Sub FrmPMemoDiaCuttingPlan_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        ...
        End If
    End Sub
    Private Sub FrmPMemoDiaCuttingPlan_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Public Sub FrmPMemoDiaCuttingPlan_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
EventExitSub:
    ...
    Private Sub txtEmp_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtEmp.Validating
        ...
        If MainClass.ValidateWithMasterTable(txtEmp.Text, "USER_ID", "EMP_NAME", "ATH_PASSWORD_MST", PubDBCn, MasterNo, , SqlStr) = True Then
...
EventExitSub:
    ...
    Private Sub txtThickness_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtThickness.Validating
        ...
        'txtNetRMWtz.Text = VB6.Format(mWeightPerStrip * Val(txtRMQty.Text), "0.00")
        'CalcTots()
        'eventArgs.Cancel = Cancel
    End Sub

    Private Sub txtNetRMWt_Validating(sender As Object, e As CancelEventArgs) Handles txtNetRMWt.Validating
        'Dim Cancel As Boolean = e.Cancel
        'Dim mWeightPerStrip As Double

        'If Val(txtLength.Text) = 0 Then
        '    txtLength.Text = GetRodLength(Val(txtThickness.Text), Val(txtNetRMWtz.Text), Val(lblDensity.Text))
        'Else
        '    mWeightPerStrip = GetWeightPerStrip(Val(txtThickness.Text), Val(txtLength.Text), Val(txtWidth.Text), Val(lblDensity.Text))
    ...
    End Sub
    Private Sub SprdMainScrap_ClickEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_ClickEvent) Handles SprdMainScrap.ClickEvent
        ...
        If eventArgs.row = 0 And eventArgs.col = ColItemCode Then
            With SprdMainScrap
                ...
                .Col = ColItemCode
                SqlStr = "SELECT IMST.ITEM_CODE, IMST.ITEM_SHORT_DESC,IMST.ISSUE_UOM " & vbCrLf _
                        & " FROM INV_ITEM_MST IMST, INV_GENERAL_MST GMAT" & vbCrLf _
                        & " WHERE IMST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf _
                        & " AND IMST.COMPANY_CODE=GMAT.COMPANY_CODE " & vbCrLf _
                        & " AND IMST.CATEGORY_CODE=GMAT.GEN_CODE AND  GMAT.GEN_TYPE='C' AND PRD_TYPE='4'"
                ...
                If MainClass.SearchGridMasterBySQL2(.Text, SqlStr) = True Then
                    ...
                    .Col = ColItemDesc
                    .Text = Trim(AcName1)
                    'Call SprdMainScrap_LeaveCell(ColItemCode, .ActiveRow, ColItemCode, .ActiveRow, False)
                    Call SprdMainScrap_LeaveCell(SprdMainScrap, New AxFPSpreadADO._DSpreadEvents_LeaveCellEvent(ColItemCode, .ActiveRow, ColItemCode, .ActiveRow, False))
                End If
        ...
        If eventArgs.row = 0 And eventArgs.col = ColItemDesc Then
            With SprdMainScrap
                ...
                SqlStr = "SELECT IMST.ITEM_SHORT_DESC, IMST.ITEM_CODE, IMST.ISSUE_UOM " & vbCrLf _
                        & " FROM INV_ITEM_MST IMST, INV_GENERAL_MST GMAT" & vbCrLf _
                        & " WHERE IMST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf _
                        & " AND IMST.COMPANY_CODE=GMAT.COMPANY_CODE " & vbCrLf _
                        & " AND IMST.CATEGORY_CODE=GMAT.GEN_CODE AND  GMAT.GEN_TYPE='C' AND PRD_TYPE='4'"
        ...
        If eventArgs.col = 0 And eventArgs.row > 0 Then
            SprdMainScrap.Row = eventArgs.row
            SprdMainScrap.Col = ColItemCode
            If eventArgs.row < SprdMainScrap.MaxRows And (ADDMode = True Or MODIFYMode = True) Then
                MainClass.DeleteSprdRow(SprdMainScrap, eventArgs.row, ColItemCode)
                MainClass.SaveStatus(Me.cmdSave, ADDMode, MODIFYMode)
                FormatSprdMain(eventArgs.row)
            End If
        End If
    ...
    Private Sub SprdMainScrap_LeaveCell(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_LeaveCellEvent) Handles SprdMainScrap.LeaveCell
        ...
        SprdMainScrap.Row = SprdMainScrap.ActiveRow
        SprdMainScrap.Col = ColItemCode
        If Trim(SprdMainScrap.Text) = "" Then Exit Sub
        Select Case eventArgs.col
            Case ColItemCode
                SprdMainScrap.Row = SprdMainScrap.ActiveRow
                SprdMainScrap.Col = ColItemCode
                If DuplicateScrapItem() = False Then
                    SprdMainScrap.Row = SprdMainScrap.ActiveRow
                    SprdMainScrap.Col = ColItemCode
                    If FillScrapItemDescPart(Trim(SprdMainScrap.Text), mDivisionCode) = False Then
                        MainClass.SetFocusToCell(SprdMainScrap, SprdMainScrap.ActiveRow, ColItemCode)
                        eventArgs.cancel = True
                        Exit Sub
                    Else
                        MainClass.AddBlankSprdRow(SprdMainScrap, ColItemCode, ConRowHeight)
                        FormatSprdMain((SprdMainScrap.MaxRows))
                    End If
                Else
                    MainClass.SetFocusToCell(SprdMainScrap, SprdMainScrap.ActiveRow, ColItemCode)
                    eventArgs.cancel = True
...
ErrPart:
    ...
    Private Sub SprdMainScrap_Change(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_ChangeEvent) Handles SprdMainScrap.Change

        MainClass.SaveStatus(Me.cmdSave, ADDMode, MODIFYMode)
    End Sub
    Private Sub SprdMainScrap_KeyUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_KeyUpEvent) Handles SprdMainScrap.KeyUpEvent
        Dim mCol As Short
        Dim mRow As Short

        mCol = SprdMainScrap.ActiveCol
        mRow = SprdMainScrap.ActiveRow

        If eventArgs.keyCode = System.Windows.Forms.Keys.F1 And mCol = ColItemCode Then SprdMainScrap_ClickEvent(SprdMainScrap, New AxFPSpreadADO._DSpreadEvents_ClickEvent(ColItemCode, 0))
        If eventArgs.keyCode = System.Windows.Forms.Keys.F1 And mCol = ColItemDesc Then SprdMainScrap_ClickEvent(SprdMainScrap, New AxFPSpreadADO._DSpreadEvents_ClickEvent(ColItemDesc, 0))


    End Sub

    Private Sub txtHeatNo_TextChanged(sender As Object, e As EventArgs) Handles txtHeatNo.TextChanged
        MainClass.SaveStatus(Me.cmdSave, ADDMode, MODIFYMode)
    End Sub
    Private Sub txtHeatNo_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtHeatNo.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)

        KeyAscii = MainClass.UpperCase(KeyAscii, txtHeatNo.Text)
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
        End If
    ...
    Private Sub txtHeatNo_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles txtHeatNo.KeyUp
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        If KeyCode = System.Windows.Forms.Keys.F1 Then Call cmdSearchHeatNo_Click(cmdSearchHeatNo, New System.EventArgs())
    End Sub

    Private Sub txtHeatNo_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtHeatNo.Validating
        Dim Cancel As Boolean = eventArgs.Cancel
        ...
        If Trim(txtRMCode.Text) = "" Then GoTo EventExitSub

        If Trim(txtHeatNo.Text) = "" Then GoTo EventExitSub
        ...
        '    & " FROM INV_ITEM_MST " & vbCrLf _
        '    & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf _
        '    & " AND LTRIM(RTRIM(ITEM_CODE))='" & MainClass.AllowSingleQuote(txtHeatNo.Text) & "'"
        ...
        mAvailable = GetBalanceStockQty(Trim(txtRMCode.Text), (txtPMemoDate.Text), lblRMUOM.Text, (txtDept.Text), IIf(Mid(cboProductionFrom.Text, 1, 1) = "F", "ST", "CL"), "", ConPH, mDivisionCode, ConStockRefType_PMEMODEPT, Val(txtPMemoNo.Text),,, Trim(txtHeatNo.Text))
        txtStockQty.Text = VB6.Format(mAvailable, "0.00")
...
EventExitSub:
        eventArgs.Cancel = Cancel
    End Sub
    Private Sub cmdSearchHeatNo_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSearchHeatNo.Click
        On Error GoTo ErrPart
        Dim SqlStr As String = ""

        'SqlStr = " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.RM_CODE " & vbCrLf & " FROM PRD_NEWBOM_DET IH, INV_ITEM_MST INVMST" & vbCrLf _
        '& " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
        '& " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.RM_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'"

        'SqlStr = SqlStr & vbCrLf & " UNION ALL"

        'SqlStr = SqlStr & vbCrLf & " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.ALTER_RM_CODE " & vbCrLf & " FROM PRD_BOM_ALTER_DET IH, INV_ITEM_MST INVMST" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IH.ALTER_RM_CODE=INVMST.ITEM_CODE" & vbCrLf & " AND IH.DEPT_CODE='" & Trim(txtDept.Text) & "'"

        SqlStr = GetItemHeatWiseQry(txtRMCode.Text, (txtProdDate.Text), lblRMUOM.Text, txtDept.Text, "ST", txtHeatNo.Text, ConPH, ConStockRefType_PMEMODEPT, Val(txtProdDate.Text))
        If MainClass.SearchGridMasterBySQL2(txtRMCode.Text, SqlStr) = True Then
            'txtRMCode.Text = AcName
            'lblRMCode.Text = AcName
            txtHeatNo.Text = AcName1
            If txtHeatNo.Enabled = True Then txtHeatNo.Focus()
        End If
...
ErrPart:
    ...
    Private Sub txtSearchBOM_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtSearchBOM.TextChanged
        MainClass.SaveStatus(Me.cmdSave, ADDMode, MODIFYMode)
    End Sub
    Private Sub txtSearchBOM_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtSearchBOM.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)

        KeyAscii = MainClass.UpperCase(KeyAscii, txtSearchBOM.Text)
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
        End If
    ...
    Private Sub txtSearchBOM_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles txtSearchBOM.KeyUp
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        If KeyCode = System.Windows.Forms.Keys.F1 Then Call cmdSearchBOM_Click(cmdSearchBOM, New System.EventArgs())
    End Sub
    Private Sub cmdSearchBOM_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSearchBOM.Click
        On Error GoTo ErrPart
        Dim SqlStr As String = ""
        ...
        'SqlStr = SqlStr & vbCrLf _
        '    & " AND PRODUCT_CODE LIKE '" & MainClass.AllowSingleQuote(txtSearchBOM.Text) & "%'"


        If MainClass.SearchGridMasterBySQL2(txtSearchBOM.Text, SqlStr) = True Then
            txtSearchBOM.Text = AcName1
        End If
...
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub txtSearchBOM_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtSearchBOM.Validating
        Dim Cancel As Boolean = eventArgs.Cancel
        ...
        If Trim(txtSearchBOM.Text) = "" Then Exit Sub

        SqlStr = " SELECT DISTINCT INVMST.ITEM_SHORT_DESC, IH.PRODUCT_CODE " & vbCrLf _
            & " FROM PRD_NEWBOM_HDR IH, INV_ITEM_MST INVMST" & vbCrLf _
            & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
            & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf _
            & " AND IH.PRODUCT_CODE=INVMST.ITEM_CODE" & vbCrLf _
            & " AND PRODUCT_CODE='" & MainClass.AllowSingleQuote(txtSearchBOM.Text) & "'"
        ...
        Else
            MsgInformation("Invalid BOM Code")
            Cancel = True
        End If
...
EventExitSub:
        eventArgs.Cancel = Cancel
    End Sub
    Private Sub cmdPopulateBOM_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdPopulateBOM.Click
        On Error GoTo ErrPart
        Dim SqlStr As String = ""
        Dim RsTemp As ADODB.Recordset = Nothing
        Dim mProdItemCode As String

        Dim mDivisionCode As Double = 1
        ...
        '    & " FROM PRD_NEWBOM_DET IH, PRD_NEWBOM_DET IH, INV_ITEM_MST INVMST" & vbCrLf _
        '    & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
        '    & " AND IH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf _
        ...
        SqlStr = " SELECT" & vbCrLf _
            & "  PRODUCT_CODE,RM_CODE" & vbCrLf _
            & " FROM VW_PRD_BOM_TRN TRN" & vbCrLf _
            & " WHERE TRN.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
            & " AND DEPT_CODE='" & txtDept.Text & "' AND STD_QTY>0"

        SqlStr = SqlStr & vbCrLf _
            & " START WITH PRODUCT_CODE || '-' || TRN.COMPANY_CODE ='" & MainClass.AllowSingleQuote(txtSearchBOM.Text) & "-" & RsCompany.Fields("COMPANY_CODE").Value & "'" & vbCrLf _
        ...
        If RsTemp.EOF = False Then
            txtRMCode.Text = Trim(IIf(IsDBNull(RsTemp.Fields("RM_CODE").Value), "", RsTemp.Fields("RM_CODE").Value))
            txtRMCode_Validating(txtRMCode, New System.ComponentModel.CancelEventArgs(False))

            SprdMain.Row = 1

            SprdMain.Col = ColItemCode
            SprdMain.Text = Trim(IIf(IsDBNull(RsTemp.Fields("PRODUCT_CODE").Value), "", RsTemp.Fields("PRODUCT_CODE").Value))
            mProdItemCode = Trim(SprdMain.Text)

            If FillItemDescPart(Trim(mProdItemCode), mDivisionCode) = False Then
        ...
        '    txtSearchBOM.Text = AcName1
        '    lblRMCode.Text = AcName
        '    If txtSearchBOM.Enabled = True Then txtSearchBOM.Focus()
        'End If
        ...
        '        txtSearchBOM.Text = AcName1	
        '        lblRMCode.text = AcName	
        '        If txtSearchBOM.Enabled = True Then txtSearchBOM.SetFocus	
        '    End If	
        Exit Sub
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
