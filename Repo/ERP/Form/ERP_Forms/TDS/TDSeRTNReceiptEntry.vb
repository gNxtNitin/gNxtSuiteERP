Option Strict Off
Option Explicit On
Friend Class frmTDSeRTNReceiptEntry
...
ErrPart: 
	...
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	Private Sub frmTDSeRTNReceiptEntry_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	End Sub
	Private Sub frmTDSeRTNReceiptEntry_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub SprdView_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_DblClickEvent) Handles SprdView.DblClick
		...
		SprdView.Col = 1
		txtTDSName.Text = SprdView.Text
		
		txtTDSName_Validating(txtTDSName, New System.ComponentModel.CancelEventArgs(False))
...
EventExitSub: 
	...
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	Private Sub txtTDSName_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtTDSName.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Dim MainClass_Renamed As Object
		'UPGRADE_WARNING: Couldn't resolve default property of object MainClass.UpperCase. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		KeyAscii = MainClass.UpperCase(KeyAscii, txtTDSName.Text)
		eventArgs.KeyChar = Chr(KeyAscii)
		If KeyAscii = 0 Then
			eventArgs.Handled = True
		End If
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	'UPGRADE_WARNING: Event txtTDSName.TextChanged may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub txtTDSName_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTDSName.TextChanged
		Dim MainClass_Renamed As Object
		'UPGRADE_WARNING: Couldn't resolve default property of object MainClass.SaveStatus. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		MainClass.SaveStatus(Me, ADDMode, MODIFYMode)
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	'UPGRADE_WARNING: Form event frmTDSeRTNReceiptEntry.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmTDSeRTNReceiptEntry_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
		Dim MainClass_Renamed As Object
		On Error GoTo ERR1
		Dim SqlStr As String
		
		If FormActive = True Then Exit Sub
		SqlStr = "SELECT * FROM TDS_RTN_TRN WHERE  1<>1"
...
ERR1: 
	...
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	Private Sub frmTDSeRTNReceiptEntry_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim MainClass_Renamed As Object
		On Error GoTo ErrPart
		'UPGRADE_WARNING: Screen property Screen.MousePointer has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
		System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
...
ErrPart: 
		...
		System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
	End Sub
	Private Sub frmTDSeRTNReceiptEntry_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
	...
	Private Sub Show1()
		...
		If Not RsTDSeRTN.EOF Then
			...
			txtTDSName.Text = Trim(mAccountName)
			...
			xAccountCode = RsTDSeRTN.Fields("TDSACCOUNTCODE").Value
...
UpdateError: 
		...
		System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
	End Function
	Private Sub txtTDSName_DoubleClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtTDSName.DoubleClick
		cmdsearch_Click(cmdsearch, New System.EventArgs())
	End Sub
	Private Sub txtTDSName_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles txtTDSName.KeyUp
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
	...
	Private Function FieldsVarification() As Boolean
		...
		If Trim(txtTDSName.Text) = "" Then
			MsgInformation("TDS Name is empty. Cannot Save")
			txtTDSName.Focus()
...
ERR1: 
	...
	Private Sub SetTextLength()
		...
		'UPGRADE_WARNING: TextBox property txtTDSName.MaxLength has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
		txtTDSName.Maxlength = MainClass.SetMaxLength("SUPP_CUST_NAME", "FIN_SUPP_CUST_MST", PubDBCn)
...
ERR1: 
	...
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	Private Sub txtTDSName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtTDSName.Validating
		Dim Cancel As Boolean = eventArgs.Cancel
		Dim MainClass_Renamed As Object
		On Error GoTo ERR1
		Dim mAccountCode As String
		...
		If Trim(txtTDSName.Text) = "" Then GoTo EventExitSub
		
		'UPGRADE_WARNING: Untranslated statement in txtTDSName_Validate. Please check source code.
		
		If MODIFYMode = True And RsTDSeRTN.EOF = False Then xAccountCode = RsTDSeRTN.Fields("TDSACCOUNTCODE").Value
		SqlStr = ""
		...
		Else
			...
			ElseIf MODIFYMode = True Then 
				...
				SqlStr = " SELECT * " & vbCrLf & " FROM TDS_RTN_TRN " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND TDSACCOUNTCODE = '" & MainClass.AllowSingleQuote(xAccountCode) & "'"
...
EventExitSub: 
	...
	Private Sub AssignGrid(ByRef mRefresh As Boolean)
		...
		SqlStr = " SELECT ACM.SUPP_CUST_NAME AS NAME, I_QTR_NO, II_QTR_NO, III_QTR_NO, IV_QTR_NO" & vbCrLf & " FROM TDS_RTN_TRN TRN, FIN_SUPP_CUST_MST ACM " & vbCrLf & " WHERE TRN.COMPANY_CODE = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND TRN.FYEAR = " & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND TRN.COMPANY_CODE = ACM.COMPANY_CODE " & vbCrLf & " AND TRN.TDSACCOUNTCODE = ACM.SUPP_CUST_CODE  AND HEADTYPE='T'"
	...
	Private Function Delete1() As Boolean
		...
		PubDBCn.Errors.Clear()
		PubDBCn.BeginTrans()
		If InsertIntoDelAudit(PubDBCn, "TDS_RTN_TRN", (txtTDSName.Text), RsTDSeRTN) = False Then GoTo DeleteErr
		If InsertIntoDeleteTrn(PubDBCn, "TDS_RTN_TRN", "TDSACCOUNTCODE", xAccountCode) = False Then GoTo DeleteErr
		
		'UPGRADE_WARNING: Untranslated statement in Delete1. Please check source code.
