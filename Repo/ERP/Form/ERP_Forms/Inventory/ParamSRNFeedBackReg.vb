...
Friend Class frmParamSRNFeedBackReg
    ...
    Private Sub ReportOnIssue(ByRef Mode As Crystal.DestinationConstants)
        ...
        mTitle = "STORE RETURN NOTE (FEEDBACK) Register "
        Report1.ReportFileName = My.Application.Info.DirectoryPath & "\Reports\SRNFEEDBACKREG.rpt"
        SqlStr = MakeSQL
...
ErrPart:
    ...
    End Sub
    Private Sub frmParamSRNFeedBackReg_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamSRNFeedBackReg_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    End Sub
    Private Sub frmParamSRNFeedBackReg_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamSRNFeedBackReg_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Close()
    End Sub
...
EventExitSub:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        With SprdMain
            ...
            .TypeEditLen = 255
            .TypeEditMultiLine = True
            .set_ColWidth(ColActionTaken, 15)
...
LedgError:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT ''," & vbCrLf & " IGH.AUTO_KEY_SRN," & vbCrLf & " IGD.ITEM_CODE, INVMST.ITEM_SHORT_DESC," & vbCrLf & " IGD.ITEM_UOM, IGD.REASON_DESC, TO_CHAR(IGD.RTN_QTY), " & vbCrLf & " IGH.DEPT_CODE, " & vbCrLf & " TO_CHAR(IGH.SRN_DATE,'DD/MM/YYYY')," & vbCrLf & " IGH.ACTIONTAKEN, DECODE(IGH.STATUS,'Y','CLOSED','OPEN') AS STATUS"
        ...
        MakeSQL = MakeSQL & vbCrLf & "AND IGD.TO_STOCK_TYPE='RJ' AND IGH.PRD_FLOOR='Y'"
