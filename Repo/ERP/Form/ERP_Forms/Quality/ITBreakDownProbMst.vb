...
Friend Class frmITBreakDownProbMst
...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        PubDBCn.BeginTrans()
        If InsertIntoDelAudit(PubDBCn, "IT_BDPROBLEMS_MST", (txtName.Text), RsBdProb) = False Then GoTo DeleteErr
        If InsertIntoDeleteTrn(PubDBCn, "IT_BDPROBLEMS_MST", "PROB_CODE", (txtName.Text)) = False Then GoTo DeleteErr
        SqlStr = "DELETE FROM IT_BDPROBLEMS_MST " & vbCrLf _
...
DelErrPart:
    ...
    Private Sub cmdSearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdsearch.Click
        ...
        If MainClass.SearchGridMaster("", "IT_BDPROBLEMS_MST", "PROB_DESC", "PROB_CODE", , , "COMPANY_CODE=" & RsCompany.fields("COMPANY_CODE").value & "") = True Then
...
SearchError:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmITBreakDownProbMst_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmITBreakDownProbMst_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub txtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "SELECT * FROM IT_BDPROBLEMS_MST " & vbCrLf _
                    & " WHERE COMPANY_CODE=" & RsCompany.fields("COMPANY_CODE").value & "" & vbCrLf _
                    & " AND PROB_CODE='" & MainClass.AllowSingleQuote(txtName.Text) & "'"
        ...
        Else
            ...
            ElseIf MODIFYMode = True Then
                SqlStr = ""
                SqlStr = "SELECT * FROM IT_BDPROBLEMS_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND PROB_CODE='" & MainClass.AllowSingleQuote(xCode) & "'"
...
EventExitSub:
    ...
    End Sub
    Private Sub frmITBreakDownProbMst_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated

        On Error GoTo ERR1
        If FormActive = True Then Exit Sub
        MainClass.UOpenRecordSet("Select * From IT_BDPROBLEMS_MST Where 1<>1 ", PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsBdProb, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmITBreakDownProbMst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmITBreakDownProbMst_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Show1()
        ...
        If Not RsBdProb.EOF Then
            ...
            mProbType = CInt(VB.Left(IIf(IsDbNull(RsBdProb.Fields("PROB_TYPE").Value), "", RsBdProb.Fields("PROB_TYPE").Value), 2))
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            SqlStr = "INSERT INTO IT_BDPROBLEMS_MST (" & vbCrLf _
...
err_Renamed:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT PROB_CODE,PROB_DESC,PROB_TYPE " & vbCrLf & " FROM IT_BDPROBLEMS_MST" & vbCrLf & " WHERE IT_BDPROBLEMS_MST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
    ...
    Private Sub ShowReport(ByRef Mode As Crystal.DestinationConstants)
        ...
        SqlStr = " SELECT *  " & vbCrLf & " FROM IT_BDPROBLEMS_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " ORDER BY PROB_CODE"
