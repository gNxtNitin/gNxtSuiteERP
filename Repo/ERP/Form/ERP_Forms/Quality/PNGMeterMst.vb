...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        PubDBCn.BeginTrans()
        If InsertIntoDelAudit(PubDBCn, "MAN_PNG_METER_MST", (txtName.Text), RSMeterNo, "METER_NAME") = False Then GoTo DeleteErr
        If InsertIntoDeleteTrn(PubDBCn, "MAN_PNG_METER_MST", "METER_CODE", (txtCode.Text)) = False Then GoTo DeleteErr

        SqlStr = "DELETE FROM MAN_PNG_METER_MST " & vbCrLf _
...
DelErrPart:
    ...
    Private Sub cmdsearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdsearch.Click
        ...
        If MainClass.SearchGridMaster(txtName.Text, "MAN_PNG_METER_MST", "METER_NAME", "TO_CHAR(METER_CODE)", , , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
            txtName.Text = AcName
...
SearchError:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmPNGMeterMst_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmPNGMeterMst_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub TxtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "SELECT * FROM MAN_PNG_METER_MST " & vbCrLf _
                    & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
        ...
        Else
            ...
            ElseIf MODIFYMode = True Then
                SqlStr = ""
                SqlStr = "SELECT * FROM MAN_PNG_METER_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND METER_CODE=" & Val(CStr(xCode)) & ""
...
EventExitSub:
    ...
    Private Sub txtCode_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtCode.Validating
        ...
        SqlStr = "SELECT * FROM MAN_PNG_METER_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND METER_CODE=" & Val(txtCode.Text) & ""
...
EventExitSub:
        eventArgs.Cancel = Cancel
    End Sub
    Private Sub frmPNGMeterMst_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated

        On Error GoTo ERR1
        If FormActive = True Then Exit Sub
        MainClass.UOpenRecordSet("Select * From MAN_PNG_METER_MST Where 1<>1 ", PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RSMeterNo, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmPNGMeterMst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmPNGMeterMst_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            mCode = MainClass.AutoGenVNo("SELECT MAX(METER_CODE) From MAN_PNG_METER_MST WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "", PubDBCn)
            txtCode.Text = CStr(mCode)

            '        mCode = MainClass.AutoGenRowNo("MAN_PNG_METER_MST", "CODE", PubDBCn)
            SqlStr = "INSERT INTO MAN_PNG_METER_MST (" & vbCrLf & " COMPANY_CODE, METER_CODE, METER_NAME," & vbCrLf & " ADDUSER, ADDDATE, MODUSER, MODDATE, DIV_CODE ) VALUES ( " & vbCrLf & " " & RsCompany.Fields("COMPANY_CODE").Value & ", " & vbCrLf & " " & Val(CStr(mCode)) & ", " & vbCrLf & " '" & MainClass.AllowSingleQuote(txtName.Text) & "'," & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "', " & vbCrLf & " TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'),'',''," & mDivisionCode & ")"

        Else
            SqlStr = " UPDATE MAN_PNG_METER_MST  SET " & vbCrLf & " METER_NAME='" & MainClass.AllowSingleQuote(txtName.Text) & "'," & vbCrLf & " DIV_CODE=" & Val(CStr(mDivisionCode)) & "," & vbCrLf & " MODUSER='" & MainClass.AllowSingleQuote(PubUserID) & "'," & vbCrLf & " MODDATE=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND METER_CODE= " & Val(CStr(xCode)) & ""
        End If
UpdatePart:
        PubDBCn.Execute(SqlStr)
        PubDBCn.CommitTrans()
...
err_Renamed:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT TO_CHAR(METER_CODE) AS CODE, METER_NAME " & vbCrLf & " FROM MAN_PNG_METER_MST" & vbCrLf & " WHERE MAN_PNG_METER_MST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " ORDER BY METER_NAME"
    ...
    Private Sub ShowReport(ByRef Mode As Crystal.DestinationConstants)
        ...
        Report1.Reset()
        mTitle = "PNG Meter No"
        Report1.ReportFileName = My.Application.Info.DirectoryPath & "\reports\PNGContMst.rpt"
