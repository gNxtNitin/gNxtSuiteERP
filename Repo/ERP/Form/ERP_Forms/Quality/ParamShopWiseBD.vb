...
Friend Class frmParamShopWiseBD
    ...
    Private Sub ReportOnShopBD(ByRef Mode As Crystal.DestinationConstants)
        ...
        Report1.Reset()
        mTitle = "Shop Wise Break Down Details"
...
ErrPart:
    ...
    Private Sub frmParamShopWiseBD_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
    ...
    Private Sub frmParamShopWiseBD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmParamShopWiseBD_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    Private Sub frmParamShopWiseBD_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
    ...
    Private Sub frmParamShopWiseBD_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Hide()
        Me.Close()
    End Sub
...
LedgError:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT TRIM(IH.FROM_DEPT_CODE), TRIM(IH.MACHINE_NO),IH.SLIP_DATE, " & vbCrLf _
                    & " DECODE(MST.PROB_TYPE,'M','Mechanical','E','Electrical','H','Hydraulic') AS TYPE_BD, " & vbCrLf _
                    & " TO_CHAR(IH.DOWNTIME),DEPU_REMARKS " & vbCrLf _
                    & " FROM TEMP_BREAKDOWN IH, MAN_BDPROBLEMS_MST MST " & vbCrLf _
        ...
        If cboProbType.Text <> "All" Then
            MakeSQL = MakeSQL & vbCrLf & " AND MST.PROB_TYPE='" & VB.Left(Trim(cboProbType.Text), 1) & "' "
        End If
...
ERR1:
    ...
    Private Function InsertIntoTemp() As Boolean
        ...
        If chkAll.CheckState = System.Windows.Forms.CheckState.Unchecked And Trim(txtDeptt.Text) <> "" Then
            SqlStr = SqlStr & vbCrLf & " AND MAN_BREAKDOWN_HDR.FROM_DEPT_CODE='" & MainClass.AllowSingleQuote(lblCode.Text) & "'"
        End If
