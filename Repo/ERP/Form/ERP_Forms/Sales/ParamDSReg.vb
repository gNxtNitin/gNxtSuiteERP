...
Friend Class frmParamDSReg
    ...
    Private Const colSalesOrderNo As Short = 7
    Private Const ColItemCode As Short = 8
    Private Const ColItemDesc As Short = 9

    Private Const ColUnit As Short = 10
    Private Const ColWeek1Qty As Short = 11
    Private Const ColWeek2Qty As Short = 12
    Private Const ColWeek3Qty As Short = 13
    Private Const ColWeek4Qty As Short = 14
    Private Const ColWeek5Qty As Short = 15
    Private Const ColTotQty As Short = 16
    Private Const ColRate As Short = 17
    Private Const ColValue As Short = 18
    ...
    Private Sub ReportonPO(ByRef Mode As Crystal.DestinationConstants)
        ...
        mTitle = "Delivery Schedule Register"
...
ErrPart:
    ...
    End Sub
    Private Sub frmParamDSReg_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamDSReg_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    End Sub
    Private Sub frmParamDSReg_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamDSReg_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Hide()
        Me.Close()
    End Sub
    ...
    Private Sub SprdMain_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As AxFPSpreadADO._DSpreadEvents_DblClickEvent) Handles SprdMain.DblClick
        ...
        SqlStr = "SELECT * from PUR_DELV_SCHLD_HDR WHERE AUTO_KEY_DELV=" & xDSNo & "" '' AND DELV_AMEND_NO=" & xAmendPONo & ""
        MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsTemp, ADODB.LockTypeEnum.adLockReadOnly)

        If RsTemp.EOF = False Then
            frmDS.MdiParent = Me.MdiParent
            frmDS.Show()
            '        frmDS.lblBookType.text = RsTemp!PUR_TYPE & RsTemp!ORDER_TYPE

            frmDS.frmDS_Activated(Nothing, New System.EventArgs())

            frmDS.txtDSNo.Text = RsTemp.Fields("AUTO_KEY_DELV").Value
            '        frmDS.txtAmendNo = RsTemp!AMEND_NO

            frmDS.txtDSNo_Validating(Nothing, New System.ComponentModel.CancelEventArgs(False))
...
EventExitSub:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        With SprdMain
            ...
            .TypeEditLen = 255
            .TypeEditMultiLine = True
            .set_ColWidth(colSalesOrderNo, 12)
...
LedgError:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT ''," & vbCrLf & " IH.AUTO_KEY_DELV," & vbCrLf _
            ...
            & " CMST.SUPP_CUST_NAME, IH.AUTO_KEY_PO," & vbCrLf _
            ...
            & " TO_CHAR(WEEK5_QTY),TO_CHAR(TOTAL_QTY), " & vbCrLf _
            & " TO_CHAR(GetITEMPRICE_NEW(1,1,TO_DATE('" & VB6.Format(txtDateTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'),IH.AUTO_KEY_PO,ID.ITEM_CODE)), " & vbCrLf _
            & " TO_CHAR(GetITEMPRICE_NEW(1,1,TO_DATE('" & VB6.Format(txtDateTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'),IH.AUTO_KEY_PO,ID.ITEM_CODE)*TOTAL_QTY), " & vbCrLf _
            & " IH.AUTO_KEY_DELV "

        'GETLASTITEMRATE (IH.COMPANY_CODE, ID.ITEM_CODE, IH.DELV_SCHLD_DATE, 'N',ID.ITEM_UOM, ID.ITEM_UOM,1)
        'GetITEMPRICE_NEW(1,1,TO_DATE('" & VB6.Format(txtDateTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'),IH.AUTO_KEY_PO,ID.ITEM_CODE)

        'CREATE OR REPLACE FUNCTION GETLASTITEMRATE (mCOMPANY_CODE NUMBER, mITEM_CODE CHAR, mTODATE DATE, mISCOSTPRICE CHAR,mIssueUOM CHAR, mPurUOM CHAR,mUOMFactor NUMBER)
        '" TO_CHAR(GETCURRENTPORATE(IH.COMPANY_CODE, IH.AUTO_KEY_PO, IH.PO_AMEND_NO, ID.ITEM_CODE))


        ''FROM CLAUSE...
        MakeSQL = MakeSQL & vbCrLf & " FROM PUR_DELV_SCHLD_HDR IH, PUR_DELV_SCHLD_DET ID," & vbCrLf _
        ...
        If cboStatus.SelectedIndex = 1 Then
            MakeSQL = MakeSQL & vbCrLf & "AND IH.POST_FLAG='Y' AND SCHLD_STATUS='N'"
        ...
        If chkHideZeroSchedule.CheckState = System.Windows.Forms.CheckState.Checked Then
            MakeSQL = MakeSQL & vbCrLf & "AND TOTAL_QTY>0"
        End If
