...
Friend Class frmParamF4detailInput
    Inherits System.Windows.Forms.Form
    Dim XRIGHT As String
    Private Const RowHeight As Short = 20

    Private Const ColLocked As Short = 1
    Private Const ColF4No As Short = 2
    Private Const ColF4Date As Short = 3
    ...
    Private Sub cmdPreview_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdPreview.Click
        ...
        ReportOnF4(Crystal.DestinationConstants.crptToWindow)
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub cmdPrint_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdPrint.Click
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
        ReportOnF4(Crystal.DestinationConstants.crptToPrinter)
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub ReportOnF4(ByRef Mode As Crystal.DestinationConstants)
        ...
        If OptOrderBY(0).Checked Then
            Report1.ReportFileName = My.Application.Info.DirectoryPath & "\Reports\F4InputDtl1.rpt"
        Else
            Report1.ReportFileName = My.Application.Info.DirectoryPath & "\Reports\F4InputDtl2.rpt"
        End If
...
ErrPart:
    ...
    End Sub
    Private Sub frmParamF4detailInput_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
        If FormActive = True Then Exit Sub

        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor

        Me.Text = "F4 (Input) Detail"
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
        FormActive = True
        Exit Sub
ERR1:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamF4detailInput_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    End Sub
    Private Sub frmParamF4detailInput_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamF4detailInput_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Close()
    End Sub
...
LedgError:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT ''," & vbCrLf & " IGH.AUTO_KEY_57F4," & vbCrLf & " TO_CHAR(IGH.DATE_57F4,'DD/MM/YYYY')," & vbCrLf & " CMST.SUPP_CUST_NAME," & vbCrLf & " IGD.ITEM_CODE, INVMST.ITEM_SHORT_DESC," & vbCrLf & " '', TO_CHAR(IGD.ITEM_QTY), " & vbCrLf & " IGH.AUTO_KEY_MRR,IGH.AUTO_KEY_57F4"

        ''FROM CLAUSE...
        MakeSQL = MakeSQL & vbCrLf & " FROM DSP_57F4_HDR IGH, DSP_57F4_DET IGD," & vbCrLf & " FIN_SUPP_CUST_MST CMST, INV_ITEM_MST INVMST"

        ''WHERE CLAUSE...
        MakeSQL = MakeSQL & vbCrLf & " WHERE " & vbCrLf & " IGH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IGH.AUTO_KEY_57F4=IGD.AUTO_KEY_57F4" & vbCrLf & " AND IGH.COMPANY_CODE=CMST.COMPANY_CODE" & vbCrLf & " AND IGH.SUPP_CUST_CODE=CMST.SUPP_CUST_CODE " & vbCrLf & " AND IGH.COMPANY_CODE=INVMST.COMPANY_CODE" & vbCrLf & " AND IGD.ITEM_CODE=INVMST.ITEM_CODE "



        MakeSQL = MakeSQL & vbCrLf & " AND IGH.DATE_57F4>=TO_DATE('" & VB6.Format(txtDateFrom.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND IGH.DATE_57F4<=TO_DATE('" & VB6.Format(txtDateTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
        ...
        If OptOrderBY(0).Checked = True Then
            MakeSQL = MakeSQL & vbCrLf & "ORDER BY  CMST.SUPP_CUST_NAME,IGH.AUTO_KEY_57F4, IGH.DATE_57F4 ,IGD.SERIAL_NO"
        ElseIf OptOrderBY(1).Checked = True Then
            MakeSQL = MakeSQL & vbCrLf & "ORDER BY CMST.SUPP_CUST_NAME,INVMST.ITEM_SHORT_DESC,IGH.AUTO_KEY_57F4, IGH.DATE_57F4"
        End If
        'End If
        Exit Function
ERR1:
