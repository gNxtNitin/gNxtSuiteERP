...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        PubDBCn.BeginTrans()
        If InsertIntoDelAudit(PubDBCn, "DSP_PROJECT_MST", (txtName.Text), RsProjectMst, "NAME") = False Then GoTo DeleteErr
        If InsertIntoDeleteTrn(PubDBCn, "DSP_PROJECT_MST", "NAME", (txtName.Text)) = False Then GoTo DeleteErr

        SqlStr = "DELETE FROM DSP_PROJECT_MST " & vbCrLf _
...
DelErrPart:
    ...
    Private Sub cmdsearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdsearch.Click
        ...
        If MainClass.SearchGridMaster(txtName.Text, "DSP_PROJECT_MST", "NAME", "CODE", "", "", "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
            txtName.Text = AcName
...
SearchError:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmProjectMst_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmProjectMst_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub TxtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "SELECT * FROM DSP_PROJECT_MST " & vbCrLf _
            & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
        ...
        Else
            ...
            ElseIf MODIFYMode = True Then
                SqlStr = ""
                SqlStr = "SELECT * FROM DSP_PROJECT_MST " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND CODE=" & xCode & ""
...
EventExitSub:
    ...
    End Sub
    Private Sub frmProjectMst_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated

        On Error GoTo ERR1
        If FormActive = True Then Exit Sub
        MainClass.UOpenRecordSet("Select * From DSP_PROJECT_MST Where 1<>1 ", PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsProjectMst, ADODB.LockTypeEnum.adLockReadOnly)
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmProjectMst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmProjectMst_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If RsTemp.EOF = False Then
            Do While RsTemp.EOF = False
                ...
                If ADDMode = True Then
                    mCode = AutoGenSeqNo()        ''MainClass.AutoGenRowNo("DSP_PROJECT_MST", "CODE", PubDBCn)
                    SqlStr = "INSERT INTO DSP_PROJECT_MST (" & vbCrLf _
                        & " COMPANY_CODE, CODE, NAME) VALUES ( " & vbCrLf _
                        & " " & xCompanyCode & ", " & mCode & ", '" & MainClass.AllowSingleQuote(txtName.Text) & "'" & vbCrLf _
                        & " )"

                Else
                    SqlStr = " UPDATE DSP_PROJECT_MST  SET " & vbCrLf _
...
err_Renamed:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT NAME " & vbCrLf _
            & " FROM DSP_PROJECT_MST" & vbCrLf _
            & " WHERE DSP_PROJECT_MST.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
    ...
    Private Sub ShowReportOld(ByRef Mode As Crystal.DestinationConstants)
        ...
        mTitle = ""
        Report1.Reset()
        mTitle = "Project Master"
        Report1.ReportFileName = My.Application.Info.DirectoryPath & "\reports\ProjectMaster.rpt"
