...
ClearErr:
    ...
    Private Sub Show1()
        ...
        End If
        MainClass.AssignDataInSprd(SqlStr, Adata, StrConn, "Y")
    ...
    Private Function Update1() As Boolean
        ...
        With SprdMain
            For I = 1 To .MaxRows
                ...
                SqlStr = " UPDATE INV_ITEM_MST " & vbCrLf & " SET MINIMUM_QTY=" & mMinimumQty & ", REORDER_QTY=" & mReOrder & "," & vbCrLf & " MAXIMUM_QTY=" & mMaximumQty & ",ECONOMIC_QTY=" & mInvDays & "," & vbCrLf & " ModUser='" & MainClass.AllowSingleQuote(PubUserID) & "'," & vbCrLf & " Moddate='" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "' " & vbCrLf & " WHERE Company_Code= " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND ITEM_CODE= '" & mItemCode & "' "
...
UpdateErr:
    ...
    Private Sub TxtItemName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtItemName.Validating
        ...
        If MainClass.ValidateWithMasterTable(txtItemName, "ITEM_SHORT_DESC", "ITEM_CODE", "INV_ITEM_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = False Then
