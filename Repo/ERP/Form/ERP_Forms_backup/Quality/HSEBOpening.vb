    ...
    Private Sub CmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdDelete.Click
        ...
        If Not RsPowerOpen.EOF Then
            If MsgQuestion("Want to Delete ? ") = CStr(MsgBoxResult.Yes) Then ' User chose Yes.
                ...
                PubDBCn.BeginTrans()
                If InsertIntoDelAudit(PubDBCn, "MAN_HSEB_OPEN", (txtOpenDate.Text), RsPowerOpen) = False Then GoTo DelErrPart
                PubDBCn.Execute("DELETE FROM MAN_HSEB_OPEN WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND OPEN_DATE=TO_DATE('" & VB6.Format(txtOpenDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')")
                PubDBCn.CommitTrans()
                RsPowerOpen.Requery()
                Clear1()
            End If
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            ...
            SqlStr = " INSERT INTO MAN_HSEB_OPEN " & vbCrLf _
                            & " (COMPANY_CODE, OPEN_DATE, " & vbCrLf _
                            & " OPEN_KWH_READING, OPEN_KVAH_READING, " & vbCrLf _
                            & " KVA_MDI, KVA8, " & vbCrLf _
                            & " ADDUSER,ADDDATE,MODUSER,MODDATE, " & vbCrLf _
                            & " METER_CODE) " & vbCrLf _
                            & " VALUES ( " & vbCrLf _
                            & " " & RsCompany.Fields("COMPANY_CODE").Value & ",TO_DATE('" & VB6.Format(txtOpenDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf _
                            & " " & Val(txtOpenKWHReading.Text) & "," & Val(txtOpenKVAHReading.Text) & ", " & vbCrLf _
        ...
        ElseIf MODIFYMode = True Then
            SqlStr = " UPDATE MAN_HSEB_OPEN SET " & vbCrLf _
                            & " OPEN_DATE=TO_DATE('" & vb6.Format(txtOpenDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf _
                            & " OPEN_KWH_READING=" & Val(txtOpenKWHReading.Text) & ", " & vbCrLf _
                            & " OPEN_KVAH_READING=" & Val(txtOpenKVAHReading.Text) & "," & vbCrLf _
...
ErrPart:
    ...
    Private Sub frmHSEBOpening_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ...
        Me.Text = "HSEB Opening Record"

        SqlStr = "Select * From MAN_HSEB_OPEN WHERE 1<>1"
...
ERR1:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT METER_CODE," & vbCrLf & " TO_CHAR(OPEN_DATE,'DD/MM/YYYY') AS OPEN_DATE, " & vbCrLf _
            & " OPEN_KWH_READING,OPEN_KVAH_READING,KVA_MDI,KVA8 " & vbCrLf & " FROM MAN_HSEB_OPEN " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " ORDER BY OPEN_DATE"
...
ERR1:
    ...
    Private Sub frmHSEBOpening_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmHSEBOpening_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
    ...
    Private Sub Clear1()
        ...
        txtOpenKWHReading.Text = ""
        txtOpenKVAHReading.Text = ""
        txtKVAMDI.Text = ""
        txtKVA8.Text = ""
...
ClearErr:
    ...
    Private Sub SetTextLengths()
        ...
        txtOpenKWHReading.Maxlength = RsPowerOpen.Fields("OPEN_KWH_READING").Precision
        txtOpenKVAHReading.Maxlength = RsPowerOpen.Fields("OPEN_KVAH_READING").Precision
        txtKVAMDI.Maxlength = RsPowerOpen.Fields("KVA_MDI").Precision
        txtKVA8.Maxlength = RsPowerOpen.Fields("KVA8").Precision
        Exit Sub
ERR1:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
        'Resume
    ...
    Private Function FieldsVarification() As Boolean
        ...
        If Trim(txtOpenKWHReading.Text) = "" Then
            MsgInformation("KWH Reading is empty, So unable to save.")
            txtOpenKWHReading.Focus()
            FieldsVarification = False
            Exit Function
        End If
        If Trim(txtOpenKVAHReading.Text) = "" Then
            MsgInformation("KVAH Reading is empty, So unable to save.")
            txtOpenKVAHReading.Focus()
            FieldsVarification = False
            Exit Function
        End If
...
err_Renamed:
    ...
    Private Sub frmHSEBOpening_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        RsPowerOpen.Close()
        RsPowerOpen = Nothing
        'PvtDBCn.Close
        'Set PvtDBCn = Nothing
    ...
    Private Sub txtMeterFactor_Change()

        MainClass.SaveStatus(Me.cmdsave, ADDMode, MODIFYMode)
    End Sub

    Private Sub txtMeterFactor_KeyPress(ByRef KeyAscii As Short)

        KeyAscii = MainClass.SetNumericField(KeyAscii)
    End Sub

    Private Sub txtOpenKVAHReading_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtOpenKVAHReading.TextChanged

        MainClass.SaveStatus(Me.cmdsave, ADDMode, MODIFYMode)
    End Sub

    Private Sub txtOpenKVAHReading_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtOpenKVAHReading.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
    ...
    Private Sub txtOpenKWHReading_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtOpenKWHReading.TextChanged

        MainClass.SaveStatus(Me.cmdsave, ADDMode, MODIFYMode)
    End Sub

    Private Sub txtOpenKWHReading_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtOpenKWHReading.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
    ...
    Private Sub txtOpenDate_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtOpenDate.Validating
        ...
        SqlStr = "SELECT * FROM MAN_HSEB_OPEN " & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND OPEN_DATE=TO_DATE('" & VB6.Format(mDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') "
        ...
        Else
            If ADDMode = False And MODIFYMode = False Then
                ...
                Cancel = True
            ElseIf MODIFYMode = True Then
                SqlStr = "SELECT * FROM MAN_HSEB_OPEN " & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND OPEN_DATE=TO_DATE('" & VB6.Format(xMKey, "DD-MMM-YYYY") & "','DD-MON-YYYY') "
                MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsPowerOpen, ADODB.LockTypeEnum.adLockReadOnly)
            End If
        End If
        GoTo EventExitSub
...
EventExitSub:
    ...
    Private Sub Show1()
        ...
        If Not RsPowerOpen.EOF Then
            ...
            txtOpenKWHReading.Text = IIf(IsDbNull(RsPowerOpen.Fields("OPEN_KWH_READING").Value), "", RsPowerOpen.Fields("OPEN_KWH_READING").Value)
            txtOpenKVAHReading.Text = IIf(IsDbNull(RsPowerOpen.Fields("OPEN_KVAH_READING").Value), "", RsPowerOpen.Fields("OPEN_KVAH_READING").Value)
            txtKVAMDI.Text = IIf(IsDbNull(RsPowerOpen.Fields("KVA_MDI").Value), "", RsPowerOpen.Fields("KVA_MDI").Value)
            txtKVA8.Text = IIf(IsDbNull(RsPowerOpen.Fields("KVA8").Value), "", RsPowerOpen.Fields("KVA8").Value)
...
ErrPart:
    ...
    Private Sub ReportOnHSEBOpening(ByRef Mode As Crystal.DestinationConstants)

    End Sub

    Private Sub cmdPreview_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdPreview.Click
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
        Call ReportOnHSEBOpening(Crystal.DestinationConstants.crptToWindow)
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub

    Private Sub cmdPrint_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdPrint.Click
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
        Call ReportOnHSEBOpening(Crystal.DestinationConstants.crptToPrinter)
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
End Class
