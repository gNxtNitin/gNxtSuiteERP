...
Friend Class frmParamMTTR
    ...
    Private Sub ReportOnMTBF(ByRef Mode As Crystal.DestinationConstants)
        ...
        Report1.ReportFileName = My.Application.Info.DirectoryPath & "\Reports\MTTR.rpt"
...
ErrPart:
    ...
    Private Sub frmParamMTTR_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
    ...
    Private Sub frmParamMTTR_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    Private Sub frmParamMTTR_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
    ...
    Private Sub frmParamMTTR_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Hide()
        Me.Close()
    End Sub
...
EventExitSub:
    ...
    Private Sub FormatSprdMain(ByRef Arow As Integer)
        ...
        With SprdMain
            ...
            .TypeEditLen = 255
            .TypeEditMultiLine = False
            .set_ColWidth(ColBreakDownDesc, 34)
...
ERR1:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT PROBLEM_FACED,PROB_DESC, " & vbCrLf _
                    ...
                    & " COMPLETION_DATE, TO_CHAR(COMP_TIME,'HH24:MI') AS COMP_TIME,DOWNTIME " & vbCrLf _
