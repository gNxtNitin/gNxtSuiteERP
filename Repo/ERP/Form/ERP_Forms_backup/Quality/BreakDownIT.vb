    ...
    Private Sub cboDivision_SelectedIndexChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDivision.SelectedIndexChanged
        ...
        With SprdMain
            For cntRow = 1 To .MaxRows
                ...
                .Col = ColStockQty
                .Text = CStr(GetBalanceStockQty(mItemCode, (txtSlipDate.Text), mUnit, (txtToDept.Text), "ST", "", ConSH, mDivisionCode, ConStockRefType_BDI, Val(txtSlipNo.Text))) '''+ GetSavedQty(pItemCode)
            Next
        End With
    ...
    Private Sub CmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdDelete.Click
        ...
        If Not RsBreakDownMain.EOF Then
            ...
            If MsgQuestion("Want to Delete ? ") = CStr(MsgBoxResult.Yes) Then ' User chose Yes.
                ...
                PubDBCn.BeginTrans()
                If InsertIntoDelAudit(PubDBCn, "IT_BREAKDOWN_HDR", (txtSlipNo.Text), RsBreakDownMain) = False Then GoTo DelErrPart
                If UpdateMachine(True) = False Then GoTo DelErrPart
                If DeleteStockTRN(PubDBCn, ConStockRefType_BDI, CStr(Val(lblMkey.Text))) = False Then GoTo DelErrPart
                PubDBCn.Execute("DELETE FROM IT_BREAKDOWN_DET WHERE AUTO_KEY_BDSLIP=" & Val(lblMkey.Text) & "")
                PubDBCn.Execute("DELETE FROM IT_BREAKDOWN_HDR WHERE AUTO_KEY_BDSLIP=" & Val(lblMkey.Text) & "")
                PubDBCn.CommitTrans()
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If IsDate(txtSlipDate.Text) = True Then
            mSlipDate = VB6.Format(txtSlipDate.Text, "DD-MMM-YYYY")
        End If

        If IsDate(txtSlipTime.Text) = True Then
            mSlipTime = VB6.Format(txtSlipTime.Text, "hh:mm")
        End If
        ...
        If ADDMode = True Then
            ...
            SqlStr = SqlStr & vbCrLf _
                            ...
                            & " TO_DATE('" & IIf(txtDeputDate.Text = "__/__/____", "", Format(txtDeputDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                            & " TO_DATE('" & IIf(txtDeputTime.Text = "__:__", "", txtDeputTime.Text) & "', 'HH24:MI')," & vbCrLf _
                            ...
                            & " TO_DATE('" & IIf(txtComptDate.Text = "__/__/____", "", Format(txtComptDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                            & " TO_DATE('" & IIf(txtComptTime.Text = "__:__", "", txtComptTime.Text) & "', 'HH24:MI')," & vbCrLf _
                            & " '" & MainClass.AllowSingleQuote(txtRemarks.Text) & "',''," & vbCrLf _
                            & " TO_DATE('" & IIf(txtCComptDate.Text = "__/__/____", "", Format(txtCComptDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                            & " TO_DATE('" & IIf(txtCComptTime.Text = "__:__", "", txtCComptTime.Text) & "', 'HH24:MI'), " & vbCrLf _
                            & " '" & MainClass.AllowSingleQuote(txtCCompldBy.Text) & "'," & Val(txtTotalTime.Text) & ", " & vbCrLf _
                            & " " & Val(txtCTotalTime.Text) & ", " & vbCrLf _
                            & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'),'',''," & mDivisionCode & "," & vbCrLf _
                            & " '" & Trim(cboType.Text) & "', '" & MainClass.AllowSingleQuote(txtIPAdress.Text) & "')"
        ElseIf MODIFYMode = True Then
            SqlStr = " UPDATE IT_BREAKDOWN_HDR SET " & vbCrLf _
                    & " AUTO_KEY_BDSLIP=" & mSlipNo & ", " & vbCrLf _
                    & " SLIP_DATE=TO_DATE('" & IIf(txtSlipDate.Text = "__/__/____", "", Format(txtSlipDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                    & " BRK_DWN_TIME=TO_DATE('" & IIf(txtSlipTime.Text = "__:__", "", txtSlipTime.Text) & "', 'HH24:MI')," & vbCrLf _
                    ...
                    & " DEPU_DATE=TO_DATE('" & IIf(txtDeputDate.Text = "__/__/____", "", Format(txtDeputDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                    & " DEPU_TIME=TO_DATE('" & IIf(txtDeputTime.Text = "__:__", "", txtDeputTime.Text) & "', 'HH24:MI')," & vbCrLf _
                    ...
                    & " COMPLETION_DATE=TO_DATE('" & IIf(txtComptDate.Text = "__/__/____", "", Format(txtComptDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                    & " COMPLETION_TIME=TO_DATE('" & IIf(txtComptTime.Text = "__:__", "", txtComptTime.Text) & "', 'HH24:MI')," & vbCrLf _
                    & " COMPLETION_REMARKS='" & MainClass.AllowSingleQuote(txtRemarks.Text) & "',AUTO_KEY_DLYRPT=''," & vbCrLf _
                    & " CCOMPLET_DATE=TO_DATE('" & IIf(txtCComptDate.Text = "__/__/____", "", Format(txtCComptDate.Text, "DD-MMM-YYYY")) & "','DD-MON-YYYY'), " & vbCrLf _
                    & " CCOMPLET_TIME=TO_DATE('" & IIf(txtCComptTime.Text = "__:__", "", txtCComptTime.Text) & "', 'HH24:MI')," & vbCrLf _
                    ...
                    & " PROB_TYPE='" & Trim(cboType.Text) & "', IP_ADDRESS='" & MainClass.AllowSingleQuote(txtIPAdress.Text) & "'" & vbCrLf _
...
ErrPart:
    ...
    Private Function SendMail(ByRef pFlag As Object) As Boolean
        ...
        mSubject = "IT Break Down / Issue - Department :" & Trim(lblFromDept.Text) & " From Dated : " & VB6.Format(txtSlipDate.Text) & ""

        If pFlag = "REG" Then
            mBodyText = "<html><body><b><font size=11, color=Red>Machine Break Down / Issue </font></b><br />" & "<b>Slip No       : </b>" & Trim(txtSlipNo.Text) & "<br />" & "<b>Department    : </b>" & Trim(lblFromDept.Text) & "<br />" & "<b>Dated         : </b>" & VB6.Format(txtSlipDate.Text) & "<br />" & "<b>Time          : </b>" & Trim(txtSlipTime.Text) & "<br />" & "<b>Machine No    : </b>" & Trim(txtMachineNo.Text) & "<br />" & "<b>Complained By : </b>" & Trim(lblCompldBy.Text) & "<br />" & "<b>Problem       : </b>" & Trim(lblProblem.Text) & "<br />" & "<b>Problem Type       : </b>" & Trim(cboType.Text) & "<br />" & "<b>IP Address       : </b>" & Trim(txtIPAdress.Text) & "<br />" & "</body></html>"
        Else
            mBodyText = "<html><body><b><font size=11, color=Blue>Machine Break Down / Issue (Completed)</font></b><br />" & "<b>Slip No                       : </b>" & Trim(txtSlipNo.Text) & "<br />" & "<b>Department                    : </b>" & Trim(lblFromDept.Text) & "<br />" & "<b>Completion Dated              : </b>" & VB6.Format(txtComptDate.Text) & "<br />" & "<b>Completion Time               : </b>" & Trim(txtComptTime.Text) & "<br />" & "<b>Total Break Down / Issue Time : </b>" & Trim(txtTotalTime.Text) & "<br />" & "<b>Machine No                    : </b>" & Trim(txtMachineNo.Text) & "<br />" & "<b>Deputed Person                : </b>" & Trim(lblDeputPerson.Text) & "<br />" & "<b>Action Taken                  : </b>" & Trim(txtDeputRemarks.Text) & "<br />" & "</body></html>"
        End If
...
UpMacERR:
    ...
    Private Function AutoGenKeyNo() As Double
        ...
        mAutoGen = 1
        SqlStr = ""
        SqlStr = "SELECT Max(AUTO_KEY_BDSLIP)  " & vbCrLf & " FROM IT_BREAKDOWN_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & ""
...
AutogenErr:
    ...
    Private Function UpdateDetail(ByRef mDivisionCode As Double) As Boolean
        ...
        If DeleteStockTRN(PubDBCn, ConStockRefType_BDI, (lblMkey.Text)) = False Then GoTo UpdateDetailERR
        PubDBCn.Execute("DELETE FROM IT_BREAKDOWN_DET WHERE AUTO_KEY_BDSLIP=" & Val(lblMkey.Text) & "")
...
SrchERR:
    ...
    Private Sub cmdSearchProblem_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSearchProblem.Click
        ...
        Dim SqlStr As String
        SqlStr = "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
        If MainClass.SearchGridMaster("", "IT_BDPROBLEMS_MST", "PROB_DESC", "PROB_CODE", , , SqlStr) = True Then
...
SrchProbERR:
    ...
    Private Sub cmdSearchSlipNo_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSearchSlipNo.Click
        ...
        If MainClass.SearchGridMaster(txtSlipNo.Text, "IT_BREAKDOWN_HDR", "AUTO_KEY_BDSLIP", "MACHINE_NO", "FROM_DEPT_CODE", "TO_DEPT_CODE", SqlStr) = True Then
    ...
    Private Sub frmBreakDownIT_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ...
        ElseIf lblFormType.Text = "DEL" Then
            Me.Text = "IT Break Down Complaint (Delivery)"
        ...
        SqlStr = "Select * From IT_BREAKDOWN_HDR WHERE 1<>1"
        ...
        SqlStr = "Select * From IT_BREAKDOWN_DET WHERE 1<>1"
...
ERR1:
    ...
    Private Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        SqlStr = " SELECT " & vbCrLf & " AUTO_KEY_BDSLIP AS BREAKDOWN_NUMBER,TO_CHAR(SLIP_DATE,'DD/MM/YYYY') AS SLIP_DATE,TO_CHAR(BRK_DWN_TIME,'HH24:MM') AS BRK_DWN_TIME, " & vbCrLf & " MACHINE_NO,FROM_DEPT_CODE,TO_DEPT_CODE,COMPLAINT_BY,SUSPECTED_REASON,  " & vbCrLf & " PROBLEM_FACED,DEPU_EMP_CODE,TO_CHAR(DEPU_DATE,'DD/MM/YYYY') AS DEPU_DATE,TO_CHAR(DEPU_TIME,'HH24:MM') AS DEPU_TIME, " & vbCrLf & " DEPU_REMARKS,SLIP_RECEIVED_BY,TO_CHAR(COMPLETION_DATE,'DD/MM/YYYY') AS COMPLETION_DATE,TO_CHAR(COMPLETION_TIME,'HH24:MM') AS COMPLETION_TIME, " & vbCrLf & " COMPLETION_REMARKS,PROB_TYPE,IP_ADDRESS " & vbCrLf & " FROM IT_BREAKDOWN_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " ORDER BY AUTO_KEY_BDSLIP"
...
ERR1:
    ...
    Private Sub frmBreakDownIT_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmBreakDownIT_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        cboType.Items.Add("01 : Harware Issue")
        cboType.Items.Add("02 : Software Issue")
        cboType.Items.Add("03 : ERP Issue")
...
ERR1:
    ...
    Private Function FieldsVarification() As Boolean
        ...
        If lblFormType.Text = "REG" Then
            ...
            If MainClass.ValidateWithMasterTable(txtMachineNo.Text, "MACHINE_NO", "MACHINE_DESC", "IT_MACHINE_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.fields("COMPANY_CODE").value & " AND MACHINE_UB='N' AND STATUS='O'") = False Then '' AND DIV_CODE=" & mDivisionCode & "
...
err_Renamed:
    ...
    Private Sub frmBreakDownIT_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Function FillGridRow(ByRef pItemCode As String, ByRef mDivisionCode As Double) As Boolean
        ...
        If RsMisc.EOF = False Then
            ...
            With RsMisc
                ...
                mStockQty = GetBalanceStockQty(pItemCode, (txtSlipDate.Text), mUnit, (txtToDept.Text), "ST", "", ConSH, mDivisionCode, ConStockRefType_BDI, Val(txtSlipNo.Text)) '''+ GetSavedQty(pItemCode)
...
ERR1:
    ...
    Private Sub txtCCompldBy_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtCCompldBy.Validating
        ...
        If ValidateEMP(txtCCompldBy, lblCCompldBy, True) = False Then Cancel = True
    ...
    Private Sub txtCompldBy_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtCompldBy.Validating
        Dim Cancel As Boolean = eventArgs.Cancel
        If ValidateEMP(txtCompldBy, lblCompldBy, True) = False Then
            Cancel = True
        Else
    ...
    Private Function ValidateEMP(ByRef pTextBox As System.Windows.Forms.TextBox, ByRef pLable As System.Windows.Forms.Label, ByRef pValidationCheck As Boolean) As Boolean
        ...
        If pValidationCheck = True Then
            ...
            End If
        Else
            If MainClass.ValidateWithMasterTable(pTextBox.Text, "EMP_CODE", "EMP_NAME", "PAY_EMPLOYEE_MST", PubDBCn, MasterNo, , SqlStr) = True Then
                pLable.text = MasterNo
            End If
...
EventExitSub:
    ...
    Private Function CheckDate(ByRef pTextDate As System.Windows.Forms.MaskedTextBox) As Boolean
        ...
        If pTextDate.Name = txtSlipDate.Name Then
            If (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") And (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") And (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") And (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") Then
        ...
        ElseIf pTextDate.Name = txtDeputDate.Name Then
            If (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") And (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") And (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") And (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") Then
        ...
        ElseIf pTextDate.Name = txtComptDate.Name Then
            If (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") And (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") And (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") And (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") Then
        ...
        ElseIf pTextDate.Name = txtCComptDate.Name Then
            If (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") And (Trim(txtSlipDate.Text) <> "" And Trim(txtSlipDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") And (Trim(txtDeputDate.Text) <> "" And Trim(txtDeputDate.Text) <> "__/__/____") Then
            ...
            If (Trim(txtCComptDate.Text) <> "" And Trim(txtCComptDate.Text) <> "__/__/____") And (Trim(txtComptDate.Text) <> "" And Trim(txtComptDate.Text) <> "__/__/____") Then
...
ERR1:
    ...
    Private Sub CalcTot()
        ...
        If mStartDate = "" Or mStartDate = "__/__/____" Then GoTo ForComplainerSite
        If mStartTime = "" Or mStartTime = "__:__" Then GoTo ForComplainerSite
        If mEndDate = "" Or mEndDate = "__/__/____" Then GoTo ForComplainerSite
        If mEndTime = "" Or mEndTime = "__:__" Then GoTo ForComplainerSite
...
ForComplainerSite:
        ...
        If mStartDate = "" Or mStartDate = "__/__/____" Then Exit Sub
        If mStartTime = "" Or mStartTime = "__:__" Then Exit Sub
        If mEndDate = "" Or mEndDate = "__/__/____" Then Exit Sub
    ...
    Private Sub txtDeputPerson_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtDeputPerson.Validating
        Dim Cancel As Boolean = eventArgs.Cancel
        If ValidateEMP(txtDeputPerson, lblDeputPerson, False) = False Then Cancel = True
        eventArgs.Cancel = Cancel
    End Sub
...
ValERR:
    ...
    Private Sub txtIPAdress_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtIPAdress.TextChanged
    ...
    Private Sub txtMachineNo_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtMachineNo.Validating
        ...
        Else
            SqlStr = "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND MACHINE_UB='N' AND STATUS='O'" '' AND DIV_CODE=" & mDivisionCode & ""
        End If
        If MainClass.ValidateWithMasterTable(txtMachineNo.Text, "MACHINE_NO", "MACHINE_DESC", "IT_MACHINE_MST", PubDBCn, MasterNo, , SqlStr) = False Then
            MsgBox("Machine Does Not Exist In Master.")
            Cancel = True
        Else
...
EventExitSub:
    ...
    Private Sub txtProblem_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtProblem.Validating
        ...
        SqlStr = "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & ""
        If MainClass.ValidateWithMasterTable(txtProblem.Text, "PROB_CODE", "PROB_DESC", "IT_BDPROBLEMS_MST", PubDBCn, MasterNo, , SqlStr) = False Then
...
EventExitSub:
    ...
    Private Sub Show1()
        ...
        If Not RsBreakDownMain.EOF Then
            ...
            mType = IIf(IsDbNull(RsBreakDownMain.Fields("PROB_TYPE").Value), "", RsBreakDownMain.Fields("PROB_TYPE").Value)
            ...
            txtIPAdress.Text = IIf(IsDbNull(RsBreakDownMain.Fields("IP_ADDRESS").Value), "", RsBreakDownMain.Fields("IP_ADDRESS").Value)
...
ShowErrPart:
    ...
    Private Sub ShowDetail1(ByRef mDivisionCode As Double)
        ...
        SqlStr = ""
        SqlStr = " SELECT * " & vbCrLf & " FROM IT_BREAKDOWN_DET " & vbCrLf & " WHERE AUTO_KEY_BDSLIP=" & Val(lblMkey.Text) & "" & vbCrLf & " ORDER BY SERIAL_NO"
        ...
        With RsBreakDownDetail
            ...
            Do While Not .EOF
                ...
                SprdMain.Col = ColStockQty
                SprdMain.Text = CStr(GetBalanceStockQty(mItemCode, (txtSlipDate.Text), Trim(IIf(IsDbNull(.Fields("ITEM_UOM").Value), "", .Fields("ITEM_UOM").Value)), (txtToDept.Text), "ST", "", ConSH, mDivisionCode, ConStockRefType_BDI, CDbl(txtSlipNo.Text))) '''+ GetSavedQty(pItemCode)
...
ERR1:
    ...
    Private Sub txtSlipNo_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtSlipNo.Validating
        ...
        SqlStr = "SELECT * FROM IT_BREAKDOWN_HDR " & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND AUTO_KEY_BDSLIP=" & mSlipNo & ""
        ...
        Else
            If ADDMode = False And MODIFYMode = False Then
                ...
                Cancel = True
            ElseIf MODIFYMode = True Then
                SqlStr = "SELECT * FROM IT_BREAKDOWN_HDR " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " " & vbCrLf & " AND FYEAR=" & RsCompany.Fields("FYEAR").Value & " " & vbCrLf & " AND AUTO_KEY_BDSLIP=" & Val(CStr(xMKey)) & " "
                MainClass.UOpenRecordSet(SqlStr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsBreakDownMain, ADODB.LockTypeEnum.adLockReadOnly)
            End If
        End If
        GoTo EventExitSub
...
ErrPart:
    ...
    Private Sub txtSlipRecvdBy_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtSlipRecvdBy.Validating
        Dim Cancel As Boolean = eventArgs.Cancel
        If ValidateEMP(txtSlipRecvdBy, lblSlipRecvdBy, True) = False Then Cancel = True
        eventArgs.Cancel = Cancel
    End Sub
