...
Friend Class frmTDSeReturn27_New
	...
	Private Function GetSection() As String
		...
		If frmPrintTDS.chkPrintOption(13).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'194LA'"
		End If
		
		If frmPrintTDS.chkPrintOption(14).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'194E'"
		End If
		
		If frmPrintTDS.chkPrintOption(15).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'195'"
		End If
		
		If frmPrintTDS.chkPrintOption(16).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'196A'"
		End If
		
		If frmPrintTDS.chkPrintOption(17).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'196B'"
		End If
		
		If frmPrintTDS.chkPrintOption(18).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'196C'"
		End If
		
		If frmPrintTDS.chkPrintOption(19).CheckState = System.Windows.Forms.CheckState.Checked Then
			mSection = IIf(mSection = "", "", mSection & ", ") & "'197D'"
		End If
		GetSection = mSection
...
ErrPart1: 
	...
	Private Sub ReportForTDS(ByRef Mode As Crystal.DestinationConstants)
		...
		frmPrintTDS.OptForm26.Text = "Form 27"
		...
		If frmPrintTDS.OptForm26.Checked = True Then
			...
			mReportFileName = "TDSeReturn27New.rpt"
			SqlStr = ""
		...
		ElseIf frmPrintTDS.OptForm27A.Checked = True Then 
			...
			mReportFileName = "TDSeReturn27ANEW.rpt"
			SqlStr = ""
			SqlStr = FetchRecordForReport(SqlStr, 3)
			Call ShowReport(SqlStr, mReportFileName, Mode, mTitle, mSubTitle, 3, "27")
		Else
			...
			mSubTitle = "Detail of" & "__________________" & "paid/credited during the financial year and of tax deducted at source under section " & mSection & " of Income-tax Act, 1961"
			
			mReportFileName = "TDSeReturn27AnnxNew.rpt"
			SqlStr = ""
...
ERR1: 
	...
	Private Sub ShowReport(ByRef mSqlStr As String, ByRef mRPTName As String, ByRef mMode As Crystal.DestinationConstants, ByRef mTitle As String, ByRef mSubTitle As String, ByRef mReportNo As Integer, Optional ByRef mFormName As String = "")
		...
		If mReportNo = 3 Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object MainClass.AssignCRptFormulas. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			MainClass.AssignCRptFormulas(Report1, "TotAmountPaid=""" & mTotAmountPaid & """")
			'UPGRADE_WARNING: Couldn't resolve default property of object MainClass.AssignCRptFormulas. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			MainClass.AssignCRptFormulas(Report1, "TotDeduct=""" & mTotDeduct & """")
			'UPGRADE_WARNING: Couldn't resolve default property of object MainClass.AssignCRptFormulas. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
ERR1: 
		FieldsVerification = False
	End Function
	'UPGRADE_WARNING: Form event frmTDSeReturn27_New.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Public Sub frmTDSeReturn27_New_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
		On Error GoTo ERR1
...
ERR1: 
	...
	End Sub
	'UPGRADE_NOTE: MainClass was upgraded to MainClass_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
	Private Sub frmTDSeReturn27_New_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim MainClass_Renamed As Object
...
ErrPart: 
	...
	Private Function ShowDetailAnnex() As Boolean
		...
		SqlStr = SqlStr & vbCrLf & " ORDER BY   SECTIONMST.NAME, TDS_TRN.COMPANY_CODE,  TDS_TRN.PARTYNAME, TDS_TRN.VDATE"
		...
		With SprdViewAnnex
			If RsTemp.EOF = False Then
				Do While Not RsTemp.EOF
					...
					.Col = 5
					'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
					.Text = IIf(IsDbNull(RsTemp.Fields("PARTYNAME").Value), "", RsTemp.Fields("PARTYNAME").Value)
...
ERR1: 
	...
	Private Sub FillHeadingSprdView26()
		...
		End With
	End Sub
	Private Sub frmTDSeReturn27_New_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		FormActive = False
	End Sub
	...
	Private Sub Clear1()
		...
		txtReturnPeriod.Text = mMonthType
...
ErrPart: 
	...
	Private Function PrintBH(ByRef mLineCount As Integer) As Boolean
		...
		'''6
		mString = "27" & New String(" ", 4 - Len("27"))
		mMainString = mMainString & mString
		...
		''' 22
		mString = Trim(txtReturnPeriod.Text)
	...
	Private Function PrintDD(ByRef mLineCount As Integer) As Boolean
		...
		With SprdViewAnnex
			For cntRow = 1 To .MaxRows
				...
				'''19
				.Col = 15
				mString = VB.Left(Trim(.Text), 1) & New String(" ", 1 - Len(Trim(.Text)))
				mMainString = mMainString & mString
