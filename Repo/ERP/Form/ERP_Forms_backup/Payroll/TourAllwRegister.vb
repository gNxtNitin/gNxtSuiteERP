...
Friend Class frmTourAllwReg
    ...
    Private Const ColTotalTourAllw As Short = 6
    Private Const ColBankIFSC As Short = 7
    Private Sub FormatSprd(ByRef mRow As Integer)
        ...
        With sprdAddDeduct
            ...
            .set_ColWidth(ColTotalTourAllw, 9)
...
ERR1:
    ...
    Private Sub ReportForPrint(ByRef Mode As Crystal.DestinationConstants)
        ...
        ElseIf frmPrintOTReg.optBank.Checked = True Then
            ...
            mSubTitle = "Tour Allowance For Year : " & RsCompany.Fields("FYEAR").Value

        ElseIf frmPrintOTReg.optCash.Checked = True Then
            '        If FillDataIntoPrintDummy(sprdAddDeduct, 1, sprdAddDeduct.MaxRows - 1, "CASH", False) = False Then GoTo ERR1
        ...
        ElseIf frmPrintOTReg.optBankTxt.Checked = True Then
            ...
            If CreateTxtFileForBank(sprdAddDeduct, ColCode, ColName, ColPaymentMode, ColBankAcct, ColTotalTourAllw, mBankName, pNarr, sprdAddDeduct.MaxRows - 1) = False Then GoTo ERR1
    ...
    Private Sub CalcSubTotal()
        ...
        With sprdAddDeduct
            ...
            For cntRow = 1 To .MaxRows - 1
                .Row = cntRow
                .Col = ColTotalTourAllw
                mTotTourAllw = mTotTourAllw + Val(sprdAddDeduct.Text)
            Next

            .Row = .MaxRows
            .Col = ColTotalTourAllw
            .Text = VB6.Format(mTotTourAllw, "0.00")
        End With
    End Sub
    Private Sub frmTourAllwReg_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        'RefreshScreen
    End Sub
    Private Sub frmTourAllwReg_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
    ...
    Private Sub RefreshScreen()
        ...
        SqlStr = " Select EMP.EMP_CODE, EMP.EMP_NAME, '' AS DESG_DESC, " & vbCrLf & " EMP.EMP_BANK_NO, DECODE(EMP.PAYMENTMODE,1,'CASH','CHEQUE') AS PAYMENTMODE, " & vbCrLf & " TO_CHAR(SUM(TRN.AMOUNT)) AS TourAllw "

        SqlStr = SqlStr & vbCrLf & " From PAY_EMPLOYEE_MST EMP, PAY_TOUR_TRN TRN " & vbCrLf & " WHERE  TRN.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND  TRN.FYEAR=" & RsCompany.Fields("FYEAR").Value & "" & vbCrLf & " AND TRN.COMPANY_CODE=EMP.COMPANY_CODE " & vbCrLf & " AND TRN.EMP_CODE=EMP.EMP_CODE "
        ...
        SqlStr = SqlStr & vbCrLf & " HAVING SUM(TRN.AMOUNT)>0"
