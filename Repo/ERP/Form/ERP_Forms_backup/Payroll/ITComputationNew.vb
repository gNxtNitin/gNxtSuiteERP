...
Friend Class frmITComputationNew
...
DelErrPart:
    ...
    Private Sub frmITComputationNew_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
EventExitSub:
    ...
    Private Sub TxtName_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles TxtName.TextChanged
        ...
        mDataChange = True
    End Sub
    Private Sub frmITComputationNew_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
...
ERR1:
        ...
        '    Resume
    End Sub
    Private Sub frmITComputationNew_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        'Resume
    End Sub
    Private Sub frmITComputationNew_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            ...
            SqlStr = SqlStr & vbCrLf & " " & RsCompany.Fields("COMPANY_CODE").Value & ", " & RsCompany.Fields("FYEAR").Value & ", '" & Trim(txtEmpCode.Text) & "',  " & vbCrLf & " TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & Val(CStr(mGrossSalaryA)) & ", " & Val(CStr(mGrossSalaryB)) & ", " & Val(CStr(mGrossSalaryC)) & ", " & vbCrLf & " " & Val(CStr(mGSalary)) & "," & Val(CStr(mExemptSalary)) & "," & Val(CStr(mGSAfterExempt)) & ", " & vbCrLf & " " & Val(CStr(mSDeduction)) & ", " & Val(CStr(mTaxableSalary)) & ",  " & vbCrLf & " " & Val(CStr(mOtherIncome)) & ", " & Val(CStr(mGIncome)) & ", " & Val(CStr(mDed_VIA)) & ", " & vbCrLf & " " & Val(CStr(mTax_Income)) & ", " & Val(CStr(mTotal_Tax)) & ", " & Val(CStr(mRebate_VIII)) & ", " & vbCrLf & " " & Val(CStr(mRebate_88B)) & "," & Val(CStr(mRebate_88C)) & ",  " & vbCrLf & " " & Val(CStr(mSurcharge)) & ", " & Val(CStr(mTAX_AMT)) & ", " & Val(CStr(mTAX_DED)) & ", " & Val(CStr(mTAX_PAYABLE)) & ", " & vbCrLf & " " & Val(CStr(mCessableAmount)) & ", " & Val(CStr(mCessAmount)) & ", " & vbCrLf & " " & Val(CStr(mRebate_80D)) & "," & Val(CStr(mRebate_80G)) & ",  " & Val(CStr(mRebate_80CCF)) & ", " & Val(CStr(mRebate_80C)) & ", " & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')," & vbCrLf & " " & Val(txtPrevSalary.Text) & ", " & Val(txtPrevChallan.Text) & ")"

        Else
            SqlStr = "UPDATE PAY_ITCOMP_HDR SET " & vbCrLf & " VDATE=TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf & " GSALARY_A=" & Val(CStr(mGrossSalaryA)) & ", " & vbCrLf & " GSALARY_B=" & Val(CStr(mGrossSalaryB)) & ", " & vbCrLf & " GSALARY_C=" & Val(CStr(mGrossSalaryC)) & ",  " & vbCrLf & " GSALARY=" & Val(CStr(mGSalary)) & ", " & vbCrLf & " ExemptSalary=" & Val(CStr(mExemptSalary)) & ", " & vbCrLf & " GSAfterExempt=" & Val(CStr(mGSAfterExempt)) & ", " & vbCrLf & " SDEDUCTION=" & Val(CStr(mSDeduction)) & ", " & vbCrLf & " TAXABLESALARY=" & Val(CStr(mTaxableSalary)) & ",  " & vbCrLf & " OTHERINCOME=" & Val(CStr(mOtherIncome)) & ", " & vbCrLf & " GINCOME=" & Val(CStr(mGIncome)) & ", " & vbCrLf & " DED_VIA=" & Val(CStr(mDed_VIA)) & ",  " & vbCrLf & " TAX_INCOME=" & Val(CStr(mTax_Income)) & ", " & vbCrLf & " TOTAL_TAX=" & Val(CStr(mTotal_Tax)) & ", " & vbCrLf & " REBATE_VIII=" & Val(CStr(mRebate_VIII)) & ",  " & vbCrLf & " TAXABLE_INCOME_PE=" & Val(txtPrevSalary.Text) & "," & vbCrLf & " TDS_PE=" & Val(txtPrevChallan.Text) & ","

            SqlStr = Sqlstr & vbCrLf & " REBATE_88B=" & Val(CStr(mRebate_88B)) & ", " & vbCrLf & " REBATE_88C=" & Val(CStr(mRebate_88C)) & ",  " & vbCrLf & " SURCHARGE=" & Val(CStr(mSurcharge)) & ", " & vbCrLf & " TAX_AMT=" & Val(CStr(mTAX_AMT)) & ", " & vbCrLf & " TAX_DED=" & Val(CStr(mTAX_DED)) & ", TAX_PAYABLE=" & Val(CStr(mTAX_PAYABLE)) & "," & vbCrLf & " CESSABLEAMOUNT=" & Val(CStr(mCessableAmount)) & ", CESSAMOUNT=" & Val(CStr(mCessAmount)) & ",  " & vbCrLf & " REBATE_80D=" & Val(CStr(mRebate_80D)) & "," & vbCrLf & " REBATE_80G=" & Val(CStr(mRebate_80G)) & ", REBATE_80CCF=" & Val(CStr(mRebate_80CCF)) & "," & vbCrLf & " REBATE_80C=" & Val(CStr(mRebate_80C)) & ", " & vbCrLf & " ADDUSER='" & MainClass.AllowSingleQuote(PubUserID) & "', ADDDATE=TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') " & vbCrLf & " WHERE COMPANY_CODE= " & RsCompany.Fields("COMPANY_CODE").Value & " AND FYEAR= " & RsCompany.Fields("FYEAR").Value & " " & vbCrLf & " AND EMP_CODE='" & Trim(TxtEmpCode.Text) & "'"
    ...
    Private Function UpdateTrn1() As Boolean
        ...
        With sprdIT
            For cntRow = 1 To .MaxRows
                ...
                SqlStr = " INSERT INTO PAY_ITCOMP_TRN " & vbCrLf & " ( Company_Code , FYEAR, SUBROWNO, " & vbCrLf & " EMP_CODE,VDATE,DESCRIPTION,AMOUNT1,AMOUNT2, " & vbCrLf & " AMOUNT3, AMOUNT4,TOTALAMOUNT,ISTAXABLEAMOUNT, ADDUSER, ADDDATE )  VALUES " & vbCrLf & " (" & RsCompany.Fields("COMPANY_CODE").Value & "," & RsCompany.Fields("FYEAR").Value & ", " & vbCrLf & " " & cntRow & ",'" & Trim(txtEmpCode.Text) & "',TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'), " & vbCrLf & "  '" & mDesc & "'," & mAmount1 & "," & mAmount2 & ", " & vbCrLf & " " & mAmount3 & "," & mAmount4 & ", " & vbCrLf & " " & TotalAmount & ",'" & mIsTaxable & "', " & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'))"
...
ERR1:
    ...
    Sub AssignGrid(ByRef mRefresh As Boolean)
        ...
        Dim SqlStr As String = ""
        Sqlstr = " SELECT EMP.EMP_CODE,EMP_NAME," & vbCrLf & " TO_CHAR(VDATE,'DD/MM/YYYY') AS V_DATE, " & vbCrLf & " TAX_PAYABLE As TAX_AMOUNT " & vbCrLf & " FROM PAY_EMPLOYEE_MST EMP,PAY_ITCOMP_HDR ITComp WHERE " & vbCrLf & " EMP.COMPANY_CODE=ITComp.COMPANY_CODE AND " & vbCrLf & " EMP.EMP_CODE=ITComp.EMP_CODE AND " & vbCrLf & " ITComp.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf & " ITComp.FYEAR=" & RsCompany.Fields("FYEAR").Value & " ORDER BY EMP.EMP_CODE"
...
ERR1:
    ...
    Private Sub FillSprdGrid()
        ...
        With sprdIT
            ...
            RowTaxableSalary = RowExemptSalary + 16
    ...
    Private Sub CalcSalary(ByRef mEmpCode As String, ByRef mActualSalary As Double, ByRef mActualHRA As Double, ByRef mActualConvAll As Double, ByRef mActualCEWAllowance As Double, ByRef mEstimateSalary As Double, ByRef mEstimateHRA As Double, ByRef mEstimateConvAll As Double, ByRef mEstimateCEWAllowance As Double, ByRef mActualDA As Double, ByRef mActualVDA As Double, ByRef mActualOthers As Double, ByRef mActualIncentive As Double, ByRef mActualAttnAllw As Double, ByRef mActualTourAllw As Double, ByRef mActualMedicalAllw As Double, ByRef mActualMilkAllw As Double, ByRef mActualAwardAllw As Double, ByRef mActualGiftAllw As Double, ByRef mActualWashAllw As Double, ByRef mEstimatDA As Double, ByRef mEstimatVDA As Double, ByRef mEstimatOthers As Double, ByRef mEstimatIncentive As Double, ByRef mEstimatAttnAllw As Double, ByRef mEstimatTourAllw As Double, ByRef mEstimatMedicalAllw As Double, ByRef mEstimatMilkAllw As Double, ByRef mEstimatAwardAllw As Double, ByRef mEstimatGiftAllw As Double, ByRef mEstimatWashAllw As Double, ByRef mActualCCAAllw As Double, ByRef mEstimatCCAAllw As Double, ByRef mActualSPAllw As Double, ByRef mEstimatSPAllw As Double, ByRef mActualTRANSAllw As Double, ByRef mEstimatTRANSAllw As Double, ByRef mActualEXGRATIAAllw As Double, ByRef mEstimatEXGRATIAAllw As Double, ByRef mInaam As Double)
        ...
        Sqlstr = " SELECT SUM(BASICSALARY) AS BASICSALARY1,SUM(AMOUNT) AS AMOUNT1," & vbCrLf & " ADD_DEDUCTCODE,TYPE " & vbCrLf & " FROM PAY_SALARYDEF_MST SALTRN, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SALTRN.Company_Code = ADD_DEDUCT.Company_Code(+)" & vbCrLf & " AND SALTRN.ADD_DEDUCTCODE = ADD_DEDUCT.CODE(+) " & vbCrLf & " AND EMP_CODE = '" & mEmpCode & "'" & vbCrLf & " AND ADDDEDUCT IN (" & ConEarning & ")" & vbCrLf & " AND SALARY_EFF_DATE=(SELECT MAX(SALARY_EFF_DATE) FROM PAY_SALARYDEF_MST " & vbCrLf & " WHERE Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND EMP_CODE = '" & mEmpCode & "'" & vbCrLf & " AND SALARY_APP_DATE<=TO_DATE('" & VB6.Format(mSalDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'))" & vbCrLf & " GROUP BY ADD_DEDUCTCODE,TYPE"

        ''," & ConPerks & "
        '& " AND SALTRN.FYEAR = " & RsCompany.Fields("FYEAR").Value & "" & vbCrLf _
        '
...
ShowErrPart:
    ...
    Private Function CalcArrearSalary(ByRef mEmpCode As String, ByRef xArrearSal As Double) As Double
        ...
        SqlStr = " SELECT SUM(PAYABLESALARY) AS BASICSALARY1,SUM(PayableAmount) AS AMOUNT1," & vbCrLf & " SALHEADCODE,TYPE " & vbCrLf & " FROM PAY_SAL_TRN SALTRN, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SALTRN.Company_Code = ADD_DEDUCT.Company_Code(+)" & vbCrLf & " AND SALTRN.SALHEADCODE = ADD_DEDUCT.CODE(+) " & vbCrLf & " AND EMP_CODE = '" & mEmpCode & "'" & vbCrLf & " AND ADDDEDUCT=" & ConEarning & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND ISARREAR IN ('Y','O')" & vbCrLf & " GROUP BY SALHEADCODE,TYPE "
...
SearchRow:
        ...
        If RsTemp.EOF = False Then
            ...
            SqlStr = " SELECT SUM(PAYABLESALARY) AS BASICSALARY1,SUM(PayableAmount) AS AMOUNT1," & vbCrLf & " SALHEADCODE,TYPE " & vbCrLf & " FROM PAY_SAL_TRN SALTRN, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & mFromEmpCompany & "" & vbCrLf & " AND SALTRN.Company_Code = ADD_DEDUCT.Company_Code(+)" & vbCrLf & " AND SALTRN.SALHEADCODE = ADD_DEDUCT.CODE(+) " & vbCrLf & " AND EMP_CODE = '" & mFromEmpCode & "'" & vbCrLf & " AND ADDDEDUCT=" & ConEarning & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(mFromEmpLeaveDate, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND ISARREAR IN ('Y','O')" & vbCrLf & " GROUP BY SALHEADCODE,TYPE "
...
ERR1:
    ...
    Private Sub txtEmpCode_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtEmpCode.Validating
        ...
        If MainClass.ValidateWithMasterTable(mEmpCode, "EMP_CODE", "EMP_NAME", "PAY_EMPLOYEE_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "") = True Then
            ...
            SqlStr = " SELECT * FROM PAY_ITCOMP_HDR WHERE " & vbCrLf _
...
EventExitSub:
    ...
    Private Sub CalcGridTotal()
        ...
        With sprdIT
            ...
            mTaxableSalary = mTotalHeading - mOtherDed
...
ErrPart:
    ...
    Private Function CalcPF(ByRef mCode As String) As Double
        ...
        SqlStr = " SELECT SUM(PFAMT+VPFAMT) AS PFAMT1 " & vbCrLf & " FROM PAY_PFESI_TRN WHERE " & vbCrLf & " Company_Code =" & RsCompany.Fields("COMPANY_CODE").Value & " AND  " & vbCrLf & " EMP_CODE = '" & mCode & "' AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')  AND PFAMT+VPFAMT>0"
...
SearchRow:
        ...
        If RsTemp.EOF = False Then
            ...
            SqlStr = " SELECT SUM(PFAMT+VPFAMT) AS PFAMT1 " & vbCrLf & " FROM PAY_PFESI_TRN WHERE " & vbCrLf & " Company_Code =" & mFromEmpCompany & " AND  " & vbCrLf & " EMP_CODE = '" & mFromEmpCode & "' AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(mFromEmpLeaveDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')  AND PFAMT>0"
        ...
        ''            & " WHERE SD.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf _
...
ErrPart:
    ...
    Private Function CalcBonus(ByRef mCode As String, ByRef mBasicSalary As Double) As Double
        ...
        SqlStr = SqlStr & vbCrLf & " SAL_DATE, " & vbCrLf & " ISARREAR " & vbCrLf & " FROM PAY_SAL_TRN SALTRN" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND EMP_CODE = '" & mCode & "'" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(mFromDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(mToDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
        ...
        If RsSal.EOF = False Then
            Do While Not RsSal.EOF
                ...
                If RsCompany.Fields("COMPANY_CODE").Value = 2 Or RsCompany.Fields("COMPANY_CODE").Value = 12 Then
                    ...
                    If RsTemp.EOF = False Then
                        mBonusAmount = mBonusAmount + IIf(IsDBNull(RsTemp.Fields("SALPART").Value), 0, RsTemp.Fields("SALPART").Value)
                    End If
                End If
                RsSal.MoveNext()
            Loop
...
SearchRow:
            ...
            If RsTempPC.EOF = False Then
                ...
                SqlStr = " SELECT DISTINCT PAYABLESALARY, " & vbCrLf & " SAL_DATE, " & vbCrLf & " ISARREAR " & vbCrLf & " FROM PAY_SAL_TRN SALTRN" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & mFromEmpCompany & "" & vbCrLf & " AND EMP_CODE = '" & mFromEmpCode & "'" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(mFromDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(mToDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
...
ErrCalcBonus:
    ...
    Private Function CalcTourAllw(ByRef mCode As String, ByRef mBasicSalary As Double) As Double
        ...
        Else
            ...
            SqlStr = " SELECT DISTINCT PAYABLESALARY, SAL_DATE, " & vbCrLf & " ISARREAR " & vbCrLf & " FROM PAY_SAL_TRN SALTRN" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND EMP_CODE = '" & mCode & "'" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(mFromDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(mToDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
...
ErrGetMedicalPer:
    ...
    Private Function GetSurchargeRate(ByRef mAmount As Double) As Double
        ...
        SqlStr = " SELECT *  FROM PAY_ITRATE_MST WHERE " & vbCrLf _
            & " Company_Code=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf _
            & " FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND ITTYPE='SR' AND " & vbCrLf _
            & " MaxLimit = (" & vbCrLf & " SELECT MIN(MaxLimit)  FROM PAY_ITRATE_MST WHERE " & vbCrLf _
            & " Company_Code=" & RsCompany.Fields("COMPANY_CODE").Value & " AND " & vbCrLf _
            & " FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND ITTYPE='SR' AND MaxLimit >=" & mAmount & ")"

        '' AND TAX_REGIME='" & mTaxRegime & "'
...
ErrPart:
    ...
    Private Function GetMaxSalMadeDate() As String
        ...
        SqlStr = "Select MAX(SAL_DATE) as SAL_DATE From PAY_SAL_TRN " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND  SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND SAL_DATE<=TO_DATE('" & VB6.Format(RsCompany.Fields("END_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND ISARREAR IN ('N','V','F')"
...
ErrPart:
    ...
    Private Function GetConveyanceAllw(ByRef xConveyanceAllw As Double) As Double
        ...
        '',ISARREAR
        SqlStr = " SELECT SUM(PayableAmount) AS AMOUNT1," & vbCrLf & " TO_CHAR(SAL_DATE,'MM/YYYY') AS SAL_DATE" & vbCrLf & " FROM PAY_SAL_TRN SALTRN, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SALTRN.Company_Code = ADD_DEDUCT.Company_Code(+)" & vbCrLf & " AND SALTRN.SALHEADCODE = ADD_DEDUCT.CODE(+) " & vbCrLf & " AND EMP_CODE = '" & MainClass.AllowSingleQuote(txtEmpCode.Text) & "'" & vbCrLf & " AND ADDDEDUCT=" & ConEarning & " AND TYPE=" & ConConveyance & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND (ISARREAR='N' OR ISARREAR='V')" & vbCrLf & " GROUP BY TO_CHAR(SAL_DATE,'MM/YYYY')" '',ISARREAR "
        ...
        If RsTemp.EOF = False Then
            Do While Not RsTemp.EOF
                ...
                If RsTemp.Fields("AMOUNT1").Value < mConvAmountLimit Then
                    '                        mVoucherConv = GetConveyanceAllwFromVoucher(txtEmpCode.Text, RsTemp!SAL_DATE, RsCompany.Fields("COMPANY_CODE").Value)
...
SearchRow:
        ...
        '',ISARREAR
        SqlStr = " SELECT SUM(PayableAmount) AS AMOUNT1," & vbCrLf & " TO_CHAR(SAL_DATE,'MM/YYYY') AS SAL_DATE" & vbCrLf & " FROM PAY_SAL_TRN SALTRN, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.Company_Code = " & mFromCompanyCode & "" & vbCrLf & " AND SALTRN.Company_Code = ADD_DEDUCT.Company_Code(+)" & vbCrLf & " AND SALTRN.SALHEADCODE = ADD_DEDUCT.CODE(+) " & vbCrLf & " AND EMP_CODE = '" & MainClass.AllowSingleQuote(mFromEmpCode) & "'" & vbCrLf & " AND ADDDEDUCT=" & ConEarning & " AND TYPE=" & ConConveyance & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY') AND (ISARREAR='N' OR ISARREAR='V')" & vbCrLf & " " '',ISARREAR "    ''
...
ErrPart:
    ...
    Private Function CalcLeaveEncash(ByRef xEmpCode As String) As Double
        ...
        '    If MainClass.ValidateWithMasterTable(xEmpCode, "EMP_CODE", "EMP_LEAVE_DATE", "PAY_EMPLOYEE_MST", PubDBCn, MasterNo, , "COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " AND (EMP_LEAVE_DATE IS NOT NULL OR EMP_LEAVE_DATE<>'')") = True Then
        '        mLeaveDate = MasterNo
...
ErrPart:
    ...
    Private Function CalcOT(ByRef xEmpCode As String) As Double
        ...
        SqlStr = " SELECT SUM(OT_AMOUNT) AS AMOUNT FROM PAY_MONTHLY_OT_TRN " & vbCrLf & " WHERE COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND OT_Date>= TO_DATE('" & VB6.Format(RsCompany.Fields("START_DATE").Value, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND OT_Date<= TO_DATE('" & VB6.Format(txtDate.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND EMP_CODE='" & xEmpCode & "'"
        MainClass.UOpenRecordSet(Sqlstr, PubDBCn, ADODB.CursorTypeEnum.adOpenStatic, RsTemp, ADODB.LockTypeEnum.adLockReadOnly)
