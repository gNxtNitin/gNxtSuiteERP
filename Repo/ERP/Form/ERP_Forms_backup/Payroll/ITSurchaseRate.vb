...
Friend Class frmITSurchaseRate
    ...
    Private Const mITType As String = "SR"
...
DelErrPart:
    ...
    End Sub
    Private Sub frmITSurchaseRate_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
ErrPart:
        ...
        'Resume
    End Sub
    Private Sub frmITSurchaseRate_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
        SqlStr = ""
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmITSurchaseRate_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmITSurchaseRate_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Function Update1() As Boolean
        ...
        If RsTemp.EOF = False Then
            Do While RsTemp.EOF = False
                ...
                SqlStr = " DELETE FROM PAY_ITRATE_MST WHERE " & vbCrLf & " COMPANY_CODE=" & mCompanyCode & " AND " & vbCrLf & " FYEAR=" & RsCompany.Fields("FYEAR").Value & " AND ITTYPE='" & mITType & "' " & vbCrLf
                ...
                With sprdITRate
                    For cntRow = 1 To .MaxRows - 1
                        ...
                        SqlStr = " INSERT INTO PAY_ITRATE_MST " & vbCrLf & " ( COMPANY_CODE , FYEAR, SUBROWNO, AYEAR, " & vbCrLf & " MINLIMIT , MAXLIMIT, TAXPER,  ITTYPE, " & vbCrLf & " ADDUSER, ADDDATE )  VALUES " & vbCrLf & " (" & mCompanyCode & ", " & RsCompany.Fields("FYEAR").Value & ", " & vbCrLf & " " & cntRow & ", '" & MainClass.AllowSingleQuote(txtAYear.Text) & "', " & vbCrLf & " " & mMin & "," & mMax & ", " & vbCrLf & " " & mTax & ",'" & mITType & "', " & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(PubCurrDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'))"
...
DeleteErr:
    ...
    Private Sub FormatSprd(ByRef mRow As Integer)
        ...
        End With
        MainClass.UnProtectCell(sprdITRate, 1, sprdITRate.MaxRows, ColMin, ColTax)
