...
Friend Class frmSalaryRegYearlySumm
    ...
    Private Const ColPSalary As Short = 8
...
ERR1:
    ...
    Private Sub cmdRefresh_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdRefresh.Click
        ...
        End If
    End Sub
    Private Sub frmSalaryRegYearlySumm_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        'RefreshScreen
    End Sub
    Private Sub frmSalaryRegYearlySumm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
    ...
    Private Sub RefreshScreen()
        ...
        SqlStr = " SELECT EMP.EMP_CODE,EMP.EMP_NAME, EMP.EMP_FNAME, EMP.EMP_DOJ, DEPT.DEPT_DESC AS DEPARTMENT, GETEMPDESG(EMP.COMPANY_CODE,EMP.EMP_CODE,TO_DATE('" & VB6.Format(txtTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY'))  As DESG_DESC, " & vbCrLf & " SUM(SALTRN.ACTUALAMOUNT) AS ACTUALAMOUNT, SUM(SALTRN.PAYABLEAMOUNT) AS PAYABLEAMOUNT, " & vbCrLf & " SUM(SALTRN.PAYABLESALARY) AS PAYABLESALARY,SUM(SALTRN.WDAYS) AS WDAYS, SUM(SALTRN.BASICSALARY) AS BASICSALARY, " & vbCrLf & " ADD_DEDUCT.NAME AS ADDNAME, ADD_DEDUCT.ADDDEDUCT,ADD_DEDUCT.SEQ " & vbCrLf & " FROM PAY_SAL_TRN SALTRN, PAY_EMPLOYEE_MST EMP, PAY_DEPT_MST DEPT, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(txtFrom.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND EMP.EMP_STOP_SALARY='N'" & vbCrLf & " AND SALTRN.COMPANY_CODE =EMP.COMPANY_CODE" & vbCrLf & " AND SALTRN.EMP_CODE =EMP.EMP_CODE " & vbCrLf & " AND EMP.COMPANY_CODE =DEPT.COMPANY_CODE" & vbCrLf & " AND EMP.EMP_DEPT_CODE =DEPT.DEPT_CODE " & vbCrLf & " AND SALTRN.COMPANY_CODE =ADD_DEDUCT.COMPANY_CODE" & vbCrLf & " AND SALTRN.SALHEADCODE =ADD_DEDUCT.CODE "
        ...
        SqlStr = SqlStr & vbCrLf & " GROUP BY EMP.COMPANY_CODE,EMP.EMP_CODE,EMP.EMP_NAME, EMP.EMP_FNAME, DEPT.DEPT_DESC, EMP.EMP_DOJ, " & vbCrLf & " ADD_DEDUCT.NAME, ADD_DEDUCT.ADDDEDUCT, ADD_DEDUCT.SEQ "

        SqlStr = SqlStr & vbCrLf & " ORDER BY EMP.EMP_CODE, ADD_DEDUCT.SEQ "
        ...
        If RsAttn.EOF = False Then
            With sprdAttn
                ...
                Do While Not RsAttn.EOF
                    ...
                    mCode = RsAttn.Fields("EMP_CODE").Value
                    mNextCode = RsAttn.Fields("EMP_CODE").Value

                    Do While mCode = mNextCode ''mSalMonth = mSalNextMonth And mIsArrear = mIsNextArrear And
...
refreshErrPart:
    ...
    Private Sub RefreshScreenPerks()
        ...
        SqlStr = " SELECT EMP.EMP_CODE, EMP.EMP_NAME, EMP.EMP_DOJ, EMP.EMP_FNAME, '' AS EMP_DEPT_CODE,'' AS EMP_DESG_CODE," & vbCrLf & " SUM(AMOUNT) AS AMOUNT," & vbCrLf & " ADD_DEDUCT.NAME AS ADDNAME, ADD_DEDUCT.ADDDEDUCT,ADD_DEDUCT.SEQ " & vbCrLf & " FROM PAY_PERKS_TRN SALTRN, PAY_EMPLOYEE_MST EMP, PAY_SALARYHEAD_MST ADD_DEDUCT" & vbCrLf & " WHERE " & vbCrLf & " SALTRN.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND SAL_DATE>=TO_DATE('" & VB6.Format(txtFrom.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND SAL_DATE<=TO_DATE('" & VB6.Format(txtTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND EMP.EMP_STOP_SALARY='N'" & vbCrLf & " AND SALTRN.COMPANY_CODE =EMP.COMPANY_CODE" & vbCrLf & " AND SALTRN.EMP_CODE =EMP.EMP_CODE " & vbCrLf & " AND SALTRN.COMPANY_CODE =ADD_DEDUCT.COMPANY_CODE" & vbCrLf & " AND SALTRN.ADD_DEDUCTCODE =ADD_DEDUCT.CODE "
        ...
        SqlStr = SqlStr & vbCrLf & " GROUP BY EMP.EMP_CODE, EMP.EMP_NAME, EMP.EMP_DOJ, EMP.EMP_FNAME, " & vbCrLf & " ADD_DEDUCT.NAME, ADD_DEDUCT.ADDDEDUCT,ADD_DEDUCT.SEQ " ''& vbCrLf |            & " FROM PAY_PERKS_TRN SALTRN, PAY_EMPLOYEE_MST EMP, PAY_SALARYHEAD_MST ADD_DEDUCT"
        ...
        If RsAttn.EOF = False Then
            With sprdAttn
                ...
                Do While Not RsAttn.EOF
                    ...
                    mNextCode = IIf(IsDbNull(RsAttn.Fields("EMP_CODE").Value), "", RsAttn.Fields("EMP_CODE").Value)

                    Do While mCode = mNextCode
                        For cntCol = ColBSalary To .MaxCols
                            .Row = 0
                            .Col = cntCol
                            If Trim(UCase(.Text)) = "RATE-" & Trim(UCase(RsAttn.Fields("ADDNAME").Value)) Then
...
refreshErrPart:
    ...
    Private Sub FormatSprd(ByRef mRow As Integer)
        ...
        With sprdAttn
            ...
            '        .CellType = SS_CELL_TYPE_EDIT
            '        .TypeEditCharSet = SS_CELL_EDIT_CHAR_SET_ASCII
            '        .ColWidth(ColSalMonth) = 15

            '        .Col = ColPaymentType
            '        .CellType = SS_CELL_TYPE_EDIT
            '        .TypeEditCharSet = SS_CELL_EDIT_CHAR_SET_ASCII
            '        .ColWidth(ColPaymentType) = 7
            '        .ColHidden = True
...
CheckCalcOnBasicErr:
    ...
    Private Sub frmSalaryRegYearlySumm_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
        On Error GoTo ErrPart
