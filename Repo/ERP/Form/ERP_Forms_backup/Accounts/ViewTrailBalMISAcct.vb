...
Friend Class frmViewTrailBalMISAcct
...
ERR1:
    ...
    Private Sub ReportForTrailBal(ByRef Mode As Crystal.DestinationConstants)
        ...
        mSubTitle = "From: " & VB6.Format(lblDateFrom.Text, "DD MMM, YYYY") & " To: " & VB6.Format(lblDateTo.Text, "DD MMM, YYYY")
...
ERR1:
    ...
    Private Function ViewTrialSumm() As Boolean
        ...
        SqlStr = SqlStr & vbCrLf & " AND TRN.COMPANY_CODE=ACM.COMPANY_CODE " & vbCrLf & " AND TRN.ACCOUNTCODE=ACM.SUPP_CUST_CODE AND ACM.MIS_GROUP_CODE='" & MainClass.AllowSingleQuote(lblGroupCode.Text) & "'"


        SqlStr = SqlStr & vbCrLf & " AND TRN.VDate >= TO_DATE('" & VB6.Format(lblDateFrom.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')" & vbCrLf & " AND TRN.VDate <= TO_DATE('" & VB6.Format(lblDateTo.Text, "DD-MMM-YYYY") & "','DD-MON-YYYY')"
        ...
        ''********GROUP BY CLAUSE..........	
        SqlStr = SqlStr & vbCrLf & " GROUP BY " & vbCrLf & " ACM.SUPP_CUST_CODE, ACM.SUPP_CUST_NAME "
...
ViewTrialErr:
        ...
        'Resume	
    End Function
    Public Sub frmViewTrailBalMISAcct_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
        ...
        'Resume	
    End Sub
    Private Sub frmViewTrailBalMISAcct_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        Call frmViewTrailBalMISAcct_Activated(eventSender, eventArgs)
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
        Exit Sub
err_Renamed:
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmViewTrailBalMISAcct_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmViewTrailBalMISAcct_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
