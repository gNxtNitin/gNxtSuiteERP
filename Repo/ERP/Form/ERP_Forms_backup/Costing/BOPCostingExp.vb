...
ERR1:
    ...
    Private Function Delete1() As Boolean
        ...
        If Not RsCosExpMst.EOF Then
            ...
            PubDBCn.BeginTrans()
            If InsertIntoDelAudit(PubDBCn, "PRD_COSTINGEXP_MST", (txtName.Text), RsCosExpMst, "", "D") = False Then GoTo DeleteErr
...
SearchError:
        MsgBox(Err.Description)
    End Sub
    Private Sub frmBOPCostingExp_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim KeyCode As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000

        MainClass.DoFunctionKey(Me, KeyCode)
    End Sub
    Private Sub frmBOPCostingExp_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
...
ErrPart:
    ...
    Private Sub TxtName_Validating(ByVal eventSender As System.Object, ByVal eventArgs As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        ...
        SqlStr = "Select * from PRD_COSTINGEXP_MST " & vbCrLf & " Where Upper(Name)='" & MainClass.AllowSingleQuote(UCase(RTrim(LTrim(txtName.Text)))) & "' AND CATEGORY='" & lblCategory.Text & "'" & vbCrLf & " AND COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & " "
...
EventExitSub:
    ...
    Private Sub TxtName_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtName.TextChanged
        ...
        MainClass.SaveStatus(Me.CmdSave, ADDMode, MODIFYMode)
    End Sub
    Private Sub frmBOPCostingExp_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
...
ERR1:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmBOPCostingExp_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
ErrPart:
        ...
        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    End Sub
    Private Sub frmBOPCostingExp_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
ErrorHandler:
    ...
    Private Function Update1() As Boolean
        ...
        If ADDMode = True Then
            ...
            SqlStr = "Insert Into PRD_COSTINGEXP_MST (COMPANY_CODE,Code,Name, CATEGORY," & vbCrLf & " DefaultPercent,Calculation,PRINTSEQUENCE,Add_Ded," & vbCrLf & " AddUser,AddDate,ModUser,ModDate)" & vbCrLf & " Values (" & RsCompany.Fields("COMPANY_CODE").Value & "," & mCode & ", '" & MainClass.AllowSingleQuote(txtName.Text) & "', '" & lblCategory.Text & "'," & vbCrLf & " " & Val(TxtDefaultPer.Text) & ",'" & mCalculation & "', " & Val(txtSeq.Text) & ", '" & mAdd_Deduct & "'," & vbCrLf & " '" & MainClass.AllowSingleQuote(PubUserID) & "',TO_DATE('" & VB6.Format(RunDate, "DD-MMM-YYYY") & "','DD-MON-YYYY'),'','') "
        Else
