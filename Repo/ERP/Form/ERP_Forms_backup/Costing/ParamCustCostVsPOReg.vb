...
Friend Class frmParamCustCostVsPOReg
    ...
    Private Const ColOprCost As Short = 9
    Private Const ColProcessCost As Short = 10
    Private Const ColPaintCost As Short = 11
    Private Const ColPowderCost As Short = 12
    Private Const ColPlatingCost As Short = 13
    Private Const ColOHCost As Short = 14
    Private Const ColTransport As Short = 15
    Private Const ColInterest As Short = 16
    Private Const ColHandlingCost As Short = 17

    Private Const ColPackMaterialCost As Short = 18
    Private Const ColToolCost As Short = 19

    Private Const ColRejCost As Short = 20
    Private Const ColProfit As Short = 21
    ...
    Private Const ColDiff As Short = 27
...
ErrPart:
    ...
    End Sub
    Private Sub frmParamCustCostVsPOReg_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        On Error GoTo ERR1
...
ERR1:
    ...
    Private Sub frmParamCustCostVsPOReg_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub frmParamCustCostVsPOReg_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
BSLError:
    ...
    End Sub
    Private Sub frmParamCustCostVsPOReg_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
ErrPart:
        ErrorMsg(Err.Description, CStr(Err.Number), MsgBoxStyle.Critical)
    End Sub
    Private Sub frmParamCustCostVsPOReg_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormActive = False
        Me.Hide()
        Me.Close()
        Me.Dispose()
...
ErrPart:
    ...
    Private Function GetActivePO(ByRef pItemCode As String, ByRef xCustomerCode As String, ByRef pAUTO_KEY_SO As Double) As Boolean
        ...
        SqlStr = "SELECT DISTINCT AUTO_KEY_SO FROM  DSP_SALEORDER_HDR IH, DSP_SALEORDER_DET ID" & vbCrLf & " WHERE IH.COMPANY_CODE=" & RsCompany.Fields("COMPANY_CODE").Value & "" & vbCrLf & " AND IH.MKEY=ID.MKEY " & vbCrLf & " AND IH.SUPP_CUST_CODE='" & xCustomerCode & "'" & vbCrLf & " AND ID.ITEM_CODE='" & pItemCode & "'" & vbCrLf & " AND IH.SO_STATUS='O' AND ID.AMEND_WEF >=TO_DATE('" & VB6.Format(PubGSTApplicableDate, "DD-MMM-YYYY") & "','DD-MON-YYYY')" ''& vbCrLf |'                & " AND IH.AMEND_NO = ("		
        '		
...
ErrPart:
    ...
    Private Function MakeSQL() As String
        ...
        MakeSQL = " SELECT  " & vbCrLf & " IH.SUPP_CUST_CODE, CMST.SUPP_CUST_NAME, " & vbCrLf & " IH.PRODUCT_CODE, IMST.ITEM_SHORT_DESC, IMST.CUSTOMER_PART_NO, " & vbCrLf & " IH.WEF, IH.TOT_RM_COST, IH.TOT_BOP_COST, " & vbCrLf & " TOT_WELD_COST, TOT_PROCESS_COST," & vbCrLf & " PNT_TOT_COST_PC, PDR_TOT_COST_PC, PLT_TOT_COST_PC, " & vbCrLf & " OVERHEAD_COST, TRANSPORT_COST, TOT_INTEREST_COST, " & vbCrLf & " TOT_HANDLING_COST, TOT_PACK_MAT_COST, TOT_TOOL_COST, " & vbCrLf & " REJ_COST, " & vbCrLf & " PROFIT_COST,   TOT_SALE_PRICE, " & vbCrLf & " '', '', '', 0, 0 "
