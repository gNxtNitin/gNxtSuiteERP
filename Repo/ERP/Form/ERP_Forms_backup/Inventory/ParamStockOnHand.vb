    ...
    Private Function Show1() As Boolean
        ...
        If optType(0).Checked = True Then
            SqlStr = " SELECT '', GROUP_NAME, CATEGORY_NAME, SUBCATEGORY_CODE, SUBCATEGORY_NAME, " & vbCrLf _
                    & " ITEM_CODE,ITEM_NAME,ITEM_UOM,SUM(OPENING),SUM(MRR_QTY),SUM(ISSUE),SUM(CLOSING),SUM(REJ_QTY),SUM(DECODE(TOTAL_QTY,0,RATE,VALUE/TOTAL_QTY)),  SUM(MINIMUM_QTY), SUM(MAXIMUM_QTY), " & vbCrLf _
